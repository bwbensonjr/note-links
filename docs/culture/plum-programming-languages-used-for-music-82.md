...
[All entries](showlist.php)
 | 
[Concise list](showlist.php?concise=1)
...
[AC Toolbox](http://www.koncon.nl/220/SOmain.html)
...
[Adagio](http://www.cs.cmu.edu/afs/cs.cmu.edu/project/music/web/music.software.html)
...
Arctic
:   A Functional Language for Real-Time Systems.

[ARES/MARS](http://aimi.dist.unige.it/index.htm)
...
:   Concurrent, Strongly-timed, On-the-fly Audio Programming Language.

[CLM (Common Lisp Music)](http://ccrma-www.stanford.edu/CCRMA/Overview/node21.html)
...
[CMN (Common Music Notation)](http://ccrma-www.stanford.edu/CCRMA/Overview/node21.html)
...
[Cmusic](http://grasshopper.ucsd.edu/95_96/FACULTY/frm.html)
:   Language described in "Elements of Computer Music" by F. Richard Moore.

[Common Music](http://ccrma-www.stanford.edu/CCRMA/Overview/node25.html)
...
[CompoSeq5](http://kymatica.com)
:   Environment with Stackbased language for music composition. Algorithmic composition, sequences. Multitasking. Outputs through custombuilt interface, for control of analogue synthesizer hardware.

[CPN View](mailto:Donncha.OMaidin@ul.ie)
...
[Csound](http://www.leeds.ac.uk/music/Man/c_front.html)
...
[CYBIL](http://www.musique.umontreal.ca/Org/CompoElectro/CEC/)
...
[EEL2/JSFX](https://www.reaper.fm/sdk/js/js.php)
...
[Elody](http://rd.grame.fr/Elody/Elody.html)
:   Elody is a music composition environment that proposes Lambda-abstraction on musical structures as a fundamental mechanism to represent user-defined programs

[FAUST](http://faust.grame.fr/index.php/documentation)
...
[Foo](http://viswiz.gmd.de/~eckel/publications/eckel94a.html)
...
[Fugue](http://www.computer.org/tab/cgm/july91.htm)
:   Functional language for sound synthesis.

GROOVE
:   The first realtime interactive computer music performance and composition system.

[Haskore](http://haskell.systemsz.cs.yale.edu/haskore/)
...
[HMSL](http://www.softsynth.com/hmsl)
:   HMSL (Hierarchical Music Specification Language) is an object-oriented software environment for experimental music composition, with an emphasis on real-time user-machine interaction.

[Hyperlisp](http://www.idiom.com/free-compilers/TOOL/CommonLi-13.html)
...
:   A graphical editor for multidimensional and multi-formal scores, sort of poly-temporal meta-sequencer, based on the former UPIC created by Iannis Xenakis.

[Interactive Music Control](http://www.microsoft.com/music/LangReference/LangRef.htm)
:   The Microsoft Interactive Music control is an ActiveX component used to create and play music dynamically on Web pages. It is used as an object within VBScript or JavaScript programs.

[Interactor](http://www.art.net/~troika/interactor.html)
:   Interactor is a graphic authoring tool created by composers Mark Coniglio and Morton Subotnick that enables artists to realize realtime interactive performances based on MIDI.
...
[KeyKit](http://github.com/nosuchtim/keykit)
...
Keynote
:   Interpreted programming language and GUI, algorithmic and realtime MIDI processing, music editor written in Keynote itself, hence customizable, piano-roll style with pop-up menus. See also: KeyKit.

[Kinetic Music Machine](http://www.algoart.com)
:   Based on Music Box by the same author, it was enhanced and re-released as KMM

[KyCE (Kymatica Compositional Environment)](http://kymatica.com/kyce)
...
:   Lilypond is a program that typesets music from musical definitions.

[Loki](http://www.ibmpcug.co.uk/~loki/)
...
[LOOM Language Of Objects Of Music](http://www.robotsoftware.co.uk/LOOM.html)
:   A visual programming language for defining algorithmic processes and composition structures

LPC


[ManuScript](www.sibelius.com)
:   A simple CAL like language for manipulating MIDI and Sibelius specific data

MASC
:   Forth-based program on Commodore C64.
...
[MGP](http://homepages.msn.com/RedmondAve/dadani/)
:   Based in the logic of the sentences and phrases construction of a musical part.

MIDAS


[MML](http://www.faq.msxnet.org/)
:   MML is a Macro Music Language used by the BASIC interpreter on MSX home computers. It allows to define up to nine channels of MIDI or internal sounds (FM chips or AY-3-8910 chip).

[MODE](http://datura.cerl.uiuc.edu/netStuff/mode.html)
:   The Musical Object Development Environment (MODE) is a Smalltalk-80 framework and tool kit for music description, score editing, interactive performance, and digital signal processing.
...
[MPL (Musical Program Library)](http://www.timara.oberlin.edu/~gnelson/PapersPDF/GNfract.pdf)
...
[MSP](http://www.cycling74.com)
:   MSP is a MAX extention application

[MSQ](http://www.aconnect.de/friends/msq2/msq.htm)
...
:   Creates high-quality PostScript or MIDI output from a text description of music. Available for DOS and UNIX, plus in source form for compiling on many other systems.

MUS10
:   A Music V implementation at heart. Leland Smith also a possible author. MUSCMP is another name used for this program, at CCRMA.

MUS8


MusBox or MBox
:   A music compiler for the Sampson box at CCRMA. Re-implemented as "Sambox", it was the primary music making program at CCRMA between 1979 and 1990.

MUSCMP
:   A music compiler written by Tovar in the early 80's. A Music V implementation at heart.
...
Music 11
:   A successor to Music 360, Music 11 was implemented at the MIT Experimental Music Studio around 1973-1975
...
MUSIC 6
:   This might be the early (ca 1968?) predecessor of MUS10. If so, it was written by David Poole, and must have been another Music V implementation.

[Music Box](ftp://micros.hensa.ac.uk/micros/ibmpc/dos/e/e483/)
:   Program by connecting icons, represented as ascii text on the IBM PC.
...
MUSIC V
:   A widely distributed acoustic compiler.

Music-1000
:   Score and orchestra language for DMX-1000 signal processor.

MUSIC7


[MusicDNA Composer](http://www.musicdnacentral.net/index.php?p=composerHelp)
...
[MusicKit](http://ccrma-www.stanford.edu/CCRMA/Overview/node24.html)
...
[MusicScript](http://killdavid.utter-macabre.com)
:   Music scripting language that creates an entire song from a script file.Unlike Csound, this is VERY simple to understand. Made by and for musicians!
...
[NetSound](http://sound.media.mit.edu/~mkc/netsound.html)
...
[OpenMusic (OM)](http://www.ircam.fr/equipes/repmus)
...
[OSW - Open Sound World](http://osw.sourceforge.net)
...
[Patchwork](http://www.ircam.fr/produits-real/logiciels/patchwork-e.html)
...
[Pcmusic](http://grasshopper.ucsd.edu/95_96/FACULTY/frm.html)
...
[Petal](http://www.all-day-breakfast.com/rosegarden/index.html)
:   Rosegarden is an integrated MIDI sequencer and musical notation editor. It is free software for Unix and X, running on systems such as Linux, FreeBSD and SGI IRIX, and now also on OpenVMS.

PILE


Pla
:   High-level music programming language, written in SAIL. Includes concurrency bas ed on message passing.
...
[PMML](http://www-cgl.u-aizu.ac.jp/pmml/index.html)
...
[Pure Data (PD)](http://www-crca.ucsd.edu/~msp/software.html)
:   a free real-time computer music software package resembling Max.

[Pyrite](ftp://kahless.isca.uiowa.edu/pub/max/Pyrite7-1.sea.hqx)
:   A lisp-like object programming language implemented as an object to be used within the Max system.

[pysco](http://www.ulster.net/~abigoo/pw_linux/code)
...
[Quasimodo](http://www.op.net/~pbd/quasimodo/)
...
[Ravel](ftp://ftp.cs.pdx.edu/pub/music/ravel/)
:   A C-like MIDI programming language.

[Realtime Composition Library for MAX](http://www.essl.at/works/rtc.html)
...
Sambox
:   A re-implementation of MusBox, it was the primary music making program at CCRMA between 1979 and 1990.

[SAOL (MPEG-4 Structured Audio Orchestra Language)](http://sound.media.mit.edu/~eds/mpeg4/)
...
[Sapphire](ftp://sunsite.unc.edu/pub/Linux/apps/sound/editors/)
...
[SDIF](http://cnmat.cnmat.berkeley.edu/SDIF)
...
[Silence](http://www.pipeline.com/~gogins)
...
[SKINI](http://www.cs.princeton.edu/~prc/)
...
[SMDL](http://www.techno.com/SMDL.html)
...
[SMOKE](http://xcf.berkeley.edu/pub/misc/smalltalk/FAQ/2-projects.html)
...
[Snd](http://ccrma-www.stanford.edu/CCRMA/Software/snd/snd.html)
:   Snd is a sound editor modelled loosely after Emacs, and can be customized using an Emacs-lisp-like syntax

[SOUL (SOUnd Language)](https://soul.dev)
...
[SoundModel (CCPL)](http://www.speech.kth.se/~peter_l/projects/ccpl.html)
...
[Speccy](https://github.com/chr15m/speccy/)
...
SSSP
:   Structured Sound Synthesis Program.

ST


[STK (Synthesis Toolkit)](http://www.cs.princeton.edu/~prc/)
:   Synthesis toolkit, a set of Unit Generator, Musical Instrument, and Performer Model Classes in C++.
...
[SuperCollider Server](http://supercollider.sourceforge.net)
...
[Symbolic Composer](http://www.xs4all.nl/~psto/)
...
[SynSeq.pm](http://kanak.perl.it/music/)
:   A perl module for music synthesis and sequencing.

SYNTA L-II


[Tclmidi](http://jagger.me.berkeley.edu/~greg/tclmidi/)
...
[Virtual MIDI Machine](http://vmm.audionetwork.be)
