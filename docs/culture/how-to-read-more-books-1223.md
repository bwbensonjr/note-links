...
- nonfiction-book
- tutorial
summary: The author shares practical strategies for reading a book per week, emphasizing
  that the key is replacing screen time with reading by removing social media apps
  and always carrying a book everywhere. Essential habits include reading during daily
  activities, using e-readers for convenience, reading multiple books simultaneously,
  not being afraid to quit unsatisfying books, and building a personal library through
  used books. Setting reasonable reading goals, writing reviews to deepen understanding,
  and using resources like Goodreads and YouTube for recommendations help maintain
  motivation while enjoying the process rather than rushing through books.
...
![[Umberto Eco is his library]](/assets/img/umberto_eco.jpg)
