...
title: 'OpenShot Video Editor | OpenShot 4.0: Record, Edit, and Color Like Never Before'
domain: www.openshot.org
source_date: '2026-08-31'
tags:
- video
- ai
- cli-tool
summary: OpenShot 4.0 introduces major creative upgrades including a dedicated Color
  View for professional color correction and grading with tools like color wheels,
  curves, LUTs, and video scopes. The update adds a new Recording View that lets users
  capture screen, webcam, microphone, and system audio directly into projects with
  separate, editable tracks. The release also features ten new effects, local AI-powered
  subject masking, performance improvements, and a modernized interface to create
  everything from animated visualizations to cinematic film looks.
...
![OpenShot 4.0 Color View showing a video preview, timeline, color wheels, properties, and professional video scopes.](https://cdn.openshot.org/images/uploads/zinnia/2026/08/30/color-view.webp)
...
[Download OpenShot 4.0](/download/)

OpenShot 4.0 Highlights
-----------------------

* [**New Color View:**](#color-view) Correct and grade footage with approachable presets plus the precision of color wheels, curves, LUTs, and live video scopes.
* [**New Recording View:**](#recording-view) Record your microphone, screen, webcam, and system audio directly into a project, with each source kept separate and editable.
* [**10 new effects:**](#new-effects) Create audio-reactive graphics, beat-synced flashes, cinematic film looks, cleaner footage, animated timers, and more.
* [**Local AI-powered masks:**](#local-ai-masks) Select and follow subjects using free downloadable models that run on your computer, with no cloud service or subscription required.
* [**A cleaner native timeline:**](#native-timeline) Work with smoother zooming, easier keyframes, editable timecode, clearer clips, and more consistent interaction.
* [**Faster effects and editing:**](#performance) Performance work makes Blur dramatically faster while also improving Sharpen, timeline rendering, video scopes, color grading, and audio visualizations.
* [**Smarter creative workflows:**](#smarter-workflows) Reorganized menus and presets make camera moves, animation, color looks, film styles, and audio edits easier to find and apply.
* [**A more modern foundation:**](#modern-platforms) Expanded Qt 6 support improves compatibility with newer Linux distributions and lays groundwork for Android and other future platforms.
...
![OpenShot Color Grade effect with an editable color curve, color wheels, and a vectorscope](https://cdn.openshot.org/images/uploads/zinnia/2026/08/30/color-grading-curves.webp)
...
![OpenShot analyzing a selected part of a video frame with an RGB Parade scope](https://cdn.openshot.org/images/uploads/zinnia/2026/08/30/color-probe-rgb-parade.webp)
...
We also wrote a new color chapter for the [OpenShot User Guide](/user-guide/). It explains color correction, grading, scopes, skin tones, curves, wheels, and LUTs in plain language.
...
![OpenShot 4.0 Recording View with microphone, screen, and webcam controls beside the timeline](https://cdn.openshot.org/images/uploads/zinnia/2026/08/30/recording-view.webp)
...
![Detailed view of the OpenShot recording controls for microphone, screen, and webcam capture](https://cdn.openshot.org/images/uploads/zinnia/2026/08/30/recording-view-cropped.webp)
...
![Rainbow audio spectrum bars created with the OpenShot Audio Visualization effect](https://cdn.openshot.org/images/uploads/zinnia/2026/08/30/audio-rainbow-bars.webp)


Rainbow spectrum bars


![Circular rainbow audio visualization created in OpenShot](https://cdn.openshot.org/images/uploads/zinnia/2026/08/30/audio-rainbow-radial.webp)


Radial audio visualization

![OpenShot 4.0 audio visualization benchmark showing average processing rates from 172.2 to 2217.6 frames per second across ten visualization modes](https://cdn.openshot.org/images/uploads/zinnia/2026/08/30/audio-visualization-performance.webp)
...
![OpenShot Object Mask workflow selecting a subject and previewing the generated animated mask](https://cdn.openshot.org/images/uploads/zinnia/2026/08/30/ai-based-image-masks.webp)
...
![OpenShot 4.0 native timeline with two tracks, video thumbnails, audio waveforms, and clip menus](https://cdn.openshot.org/images/uploads/zinnia/2026/08/30/2-track-timeline.webp)
...
![Benchmark chart showing OpenShot 4.0 performance improvements over OpenShot 3.5.1: Blur 61.8 percent, Sharpen 12.8 percent, timeline with transforms 5.1 percent, and timeline 3.4 percent](https://cdn.openshot.org/images/uploads/zinnia/2026/08/30/performance-improvements-openshot-4.webp)
...
![OpenShot clip context menu showing quick color correction and color grading presets](https://cdn.openshot.org/images/uploads/zinnia/2026/08/30/clip-color-context-menu.webp)


Quick color options provide useful starting points while keeping every setting editable.

![OpenShot timeline showing many animation keyframes across a video clip](https://cdn.openshot.org/images/uploads/zinnia/2026/08/30/lots-of-keyframes.webp)
...
* [OpenShot Video Editor 4.0.0 release notes](https://github.com/OpenShot/openshot-qt/releases/tag/v4.0.0)
* [libopenshot 1.0.0 release notes](https://github.com/OpenShot/libopenshot/releases/tag/v1.0.0)
...
If OpenShot has helped you create, learn, teach, or share your story, please consider [supporting the project](/donate/). Donations help fund development, infrastructure, testing, documentation, and future releases.

Support OpenShot

### Give back to OpenShot ❤️

OpenShot is funded by users, not licenses.

Your support helps us fund development, releases, and infrastructure. Your name will be proudly displayed in the credits!
...
How do you want to be credited on our website and inside OpenShot?
