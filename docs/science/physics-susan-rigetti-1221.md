...
summary: Susan Rigetti's "So You Want to Learn Physics" is a comprehensive, self-study
  ...
  now in its second edition with updated textbooks and additional electives. The guide
  is designed for people from all backgrounds who want to understand physics for personal
  enrichment rather than formal academic credentials, providing a structured path
  through undergraduate and graduate-level physics topics in the proper order. Rigetti
  emphasizes that anyone can learn physics through dedicated self-study and recommends
  combining rigorous textbooks with accessible popular physics books to maintain motivation
