...
- academic-paper
- news
summary: Stanford Medicine researchers have discovered that the human brain actually
  consists of two distinct organs that evolved independently rather than developing
  from a single progenitor cell as previously believed. The forebrain and midbrain
  arise from cells expressing the Otx2 gene, while the hindbrain develops from cells
  expressing the Gbx2 gene, with these two developmental pathways running in parallel
  and never overlapping. This breakthrough enables scientists to successfully grow
  hindbrain neurons in the laboratory for the first time, opening new avenues for
  studying and potentially treating brain stem diseases like spinal muscular atrophy
  and ALS.
...
![Kyle Loh](https://med.stanford.edu/news/all-news/2026/09/two-separate-brains/_jcr_content/main/article/contentfragment/par4/image.coreimg.png/1789589762613/kyle-loh.png)
...
![Rayyan Jokhai](https://med.stanford.edu/news/all-news/2026/09/two-separate-brains/_jcr_content/main/article/contentfragment/par14/image.coreimg.jpeg/1789589825813/rayyan-jokhai.jpeg)
