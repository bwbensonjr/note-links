...
title: L'Affaire Siloxane - by Maciej Cegłowski
domain: mceglowski.substack.com
source_date: '2026-06-11'
tags:
- chemistry
- video
summary: NASA discovered that antiperspirant fumes were contaminating the International
  Space Station's water recycling system with a compound called dimethylsilanediol
  (DMSD), a siloxane that nearly forced the agency to evacuate the station in 2010.
  The mysterious contaminant, which evaporates from personal hygiene products like
  antiperspirants and hair conditioners, proved difficult to identify and analyze
  because it contaminated the laboratory equipment used to measure it. While the siloxane
  problem never reached critical evacuation levels and became a manageable recurring
  issue, it demonstrates an unexpected challenge in maintaining life support systems
  in space—the humble chemistry of everyday consumer products can wreak havoc on expensive
  orbital infrastructure.
fetch_status: success
summarizer_model: global.anthropic.claude-haiku-4-5-20251001-v1:0
---

# L'Affaire Siloxane - by Maciej Cegłowski
...
[![Maciej Cegłowski's avatar](https://substackcdn.com/image/fetch/$s_!qf2J!,w_36,h_36,c_fill,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F20e084f7-5b6f-4ce0-b4e4-ed8ebbc4b67d_484x484.jpeg)](https://substack.com/@mceglowski)

[Maciej Cegłowski](https://substack.com/@mceglowski)
...
For the love of God subscribe to Mars For The Rest of Us
