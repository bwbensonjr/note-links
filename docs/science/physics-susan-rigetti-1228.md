...
title: Physics — Susan Rigetti
domain: www.susanrigetti.com
source_date: '2026-07-13'
tags:
- physics
- tutorial
- academic-paper
summary: Susan Rigetti's "So You Want to Learn Physics" is a comprehensive, self-study
  curriculum guide that has helped over 600,000 people learn physics independently,
  now available in a second edition with updated textbooks and expanded graduate-level
  content. The guide addresses a gap in physics education by providing serious learners—from
  career-changers to curious individuals—with a structured path equivalent to undergraduate
  and master's-level physics education, emphasizing that anyone can learn physics
  regardless of their background or formal academic setting. Rigetti's mission stems
  from her belief that knowledge should be shared accessibly and that many motivated
  people are underserved by traditional academic and publishing institutions that
  underestimate their ability to understand real physics.
