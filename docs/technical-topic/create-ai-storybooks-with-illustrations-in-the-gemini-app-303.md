---
id: 303
url: https://blog.google/products/gemini/storybooks/
title: Create AI storybooks with illustrations in the Gemini app
domain: blog.google
...
- llm
- tutorial
summary: Google has introduced a new feature in the Gemini app that generates personalized,
  illustrated storybooks with AI-created artwork and narration. Users can describe
  any story idea, and Gemini will produce a 10-page book in over 45 different artistic
  styles and languages, with the option to incorporate personal photos and files for
  a custom touch. The feature is designed for various use cases, such as explaining
  complex topics to children, teaching lessons, or transforming family memories into
  engaging stories.
...
Today we’re announcing a new way to bring your ideas to life in the Gemini app: personalized, illustrated storybooks complete with read-aloud narration.
...
[Try it today in the Gemini app](http://gemini.google.com/gem/storybook). Available globally on desktop and mobile, in all languages Gemini is available.
