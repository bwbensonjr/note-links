...
In response to a question on Twitter[1](#fn:1), Richard Hipp wrote about [why SQLite uses a bytecode VM](https://sqlite.org/draft/whybytecode.html) for executing SQL statements.
...
It’s up to the debugger to evaluate the expressions. GDB and LLDB both have a switch-based interpreter for DWARF expressions.[2](#fn:2)
...
WinRAR[3](#fn:3) is a file compression utility for Windows with a proprietary file format. Tavis Ormandy, a vulnerability researcher at Google, [discovered that the RAR format includes a bytecode encoding for data transformation](https://blog.cmpxchg8b.com/2012/09/fun-with-constrained-programming.html):
...
[Massively Parallel Rendering of Complex Closed-Form Implicit Surfaces](https://www.mattkeeter.com/research/mpr/keeter_mpr20.pdf) (2020):
...
[Ubershaders: A Ridiculous Solution to an Impossible Problem](https://dolphin-emu.org/blog/2017/07/30/ubershaders/) (2017):
...
1. https://twitter.com/gorilla0513/status/1784623660193677762 [↩](#fnref:1 "Jump back to footnote 1 in the text")
2. For LLDB, see [lldb/source/Expression/DWARFExpression.cpp](https://github.com/llvm/llvm-project/blob/a04c6366b156f508cdf84a32ef4484b53a6dabee/lldb/source/Expression/DWARFExpression.cpp#L865). For GDB, see [gdb/dwarf2/expr.c](https://github.com/bminor/binutils-gdb/blob/e5dc0d5d04e68328242fc171098e78f79589c7b7/gdb/dwarf2/expr.c#L1493). [↩](#fnref:2 "Jump back to footnote 2 in the text")
3. 90s kids will remember. [↩](#fnref:3 "Jump back to footnote 3 in the text")
