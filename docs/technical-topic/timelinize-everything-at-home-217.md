...
title: Timelinize - Everything at home
domain: timelinize.com
...
- security
- github-repo
summary: '**Timelinize** is an open-source personal archival application that unifies
  all your digital data—photos, messages, emails, social media, location history,
  and more—into a single, private timeline on your own computer. Rather than relying
  on cloud storage from major tech companies, it preserves your family''s complete
  story with multiple visualization options including timeline, map, conversation,
  and gallery views. The software emphasizes privacy, portability, and local control
  while remaining compatible with data sources you already use, offering advanced
  features like entity recognition, semantic search, and automatic location processing.'
...
[Apple Photos / iCloud](/docs/data-sources/apple-photos)
[iMessage](/docs/data-sources/apple-messages)
[SMS/MMS](/docs/data-sources/android-text-messages)
[Strava](/docs/data-sources/strava)
[GitHub](/docs/data-sources/github)
[GPS](/docs/data-sources/gpx)
[Telegram](/docs/data-sources/telegram)

Files & folders

[Google Takeout](/docs/data-sources/google-photos)
[iPhone](/docs/data-sources/iphone)
[Firefox](/docs/data-sources/firefox)
...
[](/resources/videos/motion-pictures.mp4)
