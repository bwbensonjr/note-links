...
* [May 2026 (2)](/2026/05)
* [April 2026 (11)](/2026/04)
* [March 2026 (3)](/2026/03)
* [February 2026 (4)](/2026/02)
...
* [AI (83)](/ai)
* [TIL deep dives (75)](/til-deep-dives)
* [Python (72)](/python)
* [LLM from scratch (46)](/llm-from-scratch)
...
Posted on 15 [October 2025](/2025/10/)
in
[AI](/ai),
[LLM from scratch](/llm-from-scratch),
[TIL deep dives](/til-deep-dives)

This post wraps up my notes on chapter 5 of [Sebastian Raschka](https://sebastianraschka.com/)'s book
"[Build a Large Language Model (from Scratch)](https://www.manning.com/books/build-a-large-language-model-from-scratch)".
Understanding [cross entropy loss](/2025/10/llm-from-scratch-20-starting-training-cross-entropy-loss) and
[perplexity](/2025/10/llm-from-scratch-21-perplexed-by-perplexity) were the hard bits for
...
Non-trivial ML uses optimisers; I'd come across them while [fine-tuning LLMs](/fine-tuning),
and also used one in the RNN code I wrote [last week](/2025/10/revisiting-karpathy-unreasonable-effectiveness-rnns).
Instead of updating the parameters yourself, you ask the optimiser to do it for you, by
calling its `step` function. [AdamW](https://docs.pytorch.org/docs/stable/generated/torch.optim.AdamW.html) appears to be the default optimiser in most textbooks,
though [Muon](https://kellerjordan.github.io/posts/muon/) seems to be the most popular
...
Andrej Karpathy was able to [train a 124M GPT-2 model for $20](https://github.com/karpathy/llm.c/discussions/481),
...
is the 10B-token version of the [FineWeb](https://huggingface.co/datasets/HuggingFaceFW/fineweb) collection, which
is freely available. [1](#fn-1)
...
then, as the findings in the [lawsuit](https://www.nytimes.com/2023/12/27/business/media/new-york-times-open-ai-microsoft-lawsuit.html)
...
[temperature playground](/post-assets/llm-from-scratch-22-finally-training-our-llm/temperature-playground.html)
...
[Here's a link to the next post in this series](/2025/10/llm-from-scratch-23-fine-tuning-classification).

---

1. His new [nanochat](https://x.com/karpathy/status/1977755427569111362) -- a from-scratch
   trainable chatbot -- is even cooler. [↩](#fnref-1 "Jump back to footnote 1 in the text.")
...
[Writing an LLM from scratch, part 23 -- fine-tuning for classification »](/2025/10/llm-from-scratch-23-fine-tuning-classification)

Copyright (c) 2006-2026 by Giles Thomas.
