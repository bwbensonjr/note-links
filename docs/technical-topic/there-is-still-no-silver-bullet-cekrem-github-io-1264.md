...
title: There Is Still No Silver Bullet · cekrem.github.io
domain: cekrem.github.io
source_date: '2026-08-14'
tags:
- academic-paper
- llm
summary: Fred Brooks' 1986 essay "No Silver Bullet" remains remarkably prescient in
  claiming that no single technology can dramatically improve software development
  productivity, because tools can only compress the "accident" (implementation details
  like syntax and boilerplate) rather than the "essence" (the conceptual work of deciding
  what the system should do). While modern AI and LLMs are effective accident-compressors
  that can boost productivity for certain roles, they cannot accelerate the core engineering
  work of design decisions, domain understanding, and problem-solving—which is where
  most senior engineers spend their time. The claim that "code was never the hard
  part" misrepresents both Brooks' argument and software engineering history, since
  the challenging, creative work of programming happens *through* writing code, not
  separate from it.
...
[Link to heading](#the-essence-and-the-accident)
-----------------------------------------------------------------------------
...
[Link to heading](#he-even-reviewed-ai-in-1986)
---------------------------------------------------------------------------
...
A small example from my own desk. When I built the little Elm testimonials widget for this site, [I let an AI turn a pile of messy DOM nodes into clean JSON](/posts/claude-code-game-changer-or-just-hype/) — pure accident, and it spared me a genuinely boring half hour. Then I wrote the widget itself by hand, and it took roughly what it would have taken me in 2019. Not because I refused the help on principle (though, to be honest I would have – I did it for *fun* after all!), but because the hours went into deciding which states should be impossible and what the messages should mean. The hand-it-all-to-the-agent crowd tends to miss where those decisions got made: half of them happened *while writing the code*, fingers on keys, with the compiler pushing back. There was nothing to hand off, because the writing was where the deciding happened.

“Code was never the hard part”
[Link to heading](#code-was-never-the-hard-part)
-------------------------------------------------------------------------------
...
The essence gap
[Link to heading](#the-essence-gap)
---------------------------------------------------
...
[Link to heading](#grow-designers-not-prompters)
------------------------------------------------------------------------------
