...
See [Binding support](/russellromney/honker/blob/main/BINDINGS.md) for the current truth table: which
...
Binding support is tracked in [BINDINGS.md](/russellromney/honker/blob/main/BINDINGS.md). All maintained
...
Apache 2.0. See [LICENSE](/russellromney/honker/blob/main/LICENSE).
