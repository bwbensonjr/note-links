...
[![CI](https://github.com/kossisoroyce/timber/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/kossisoroyce/timber/actions/workflows/ci.yml)
[![PyPI version](https://camo.githubusercontent.com/5a44570e82d494776bf18fdbee04fa2ab56217ad04b35af34007626d097525a8/68747470733a2f2f696d672e736869656c64732e696f2f707970692f762f74696d6265722d636f6d70696c65722e737667)](https://pypi.org/project/timber-compiler/)
[![Python versions](https://camo.githubusercontent.com/dc91f52788c238a59ada5179df74110bf3e738baaa342a8cf435127f930b0d07/68747470733a2f2f696d672e736869656c64732e696f2f707970692f707976657273696f6e732f74696d6265722d636f6d70696c65722e737667)](https://pypi.org/project/timber-compiler/)
[![License: Apache-2.0](https://camo.githubusercontent.com/a549a7a30bacba7bfceebdc207a8e86c3f2c02995a2527640dca30048fd2b64e/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f4c6963656e73652d417061636865253230322e302d626c75652e737667)](/kossisoroyce/timber/blob/main/LICENSE)
[![Coverage](https://camo.githubusercontent.com/067d0133c6bd20362a02d3f421b61ca1a532e478dd5cf90e278cf10297afa1bf/68747470733a2f2f636f6465636f762e696f2f67682f6b6f737369736f726f7963652f74696d6265722f6272616e63682f6d61696e2f67726170682f62616467652e737667)](https://codecov.io/gh/kossisoroyce/timber)

[Documentation](https://kossisoroyce.github.io/timber/) ·
[Changelog](/kossisoroyce/timber/blob/main/CHANGELOG.md) ·
[PyPI](https://pypi.org/project/timber-compiler/) ·
[Technical Paper](/kossisoroyce/timber/blob/main/paper/timber_paper.pdf) ·
[Agent Skill](/kossisoroyce/timber/blob/main/skill.md)
...
| --- | --- | --- |
| XGBoost | `.json` | All objectives; multiclass, binary, regression; XGBoost 3.1+ per-class base\_score |
...
* **WCET analysis** (`timber-accel wcet`) — worst/average-case cycle counts per IR stage for Cortex-M4/M7, x86\_64, AArch64, RISC-V64 with configurable safety margin; advisory output (not a replacement for `aiT`/`RapiTime`).
...
Full CLI reference: `timber-accel --help` · Docs: [`docs/accel.md`](/kossisoroyce/timber/blob/main/docs/accel.md)
...
See [`benchmarks/`](/kossisoroyce/timber/blob/main/benchmarks) for full methodology, hardware capture script, and optional ONNX Runtime / Treelite / lleaves comparisons.
...
Runnable end-to-end examples live in [`examples/`](/kossisoroyce/timber/blob/main/examples):
...
The test suite covers: parsers (sklearn, ONNX, XGBoost, LightGBM, CatBoost, URDF), IR layer (serialization, deep\_copy, all stage types including the 5 new primitives), optimizer passes (correctness, idempotency, pipeline fusion math), C99/WASM/MISRA-C/LLVM IR emitters (compile + numeric accuracy), differential privacy (statistical correctness, all dtypes), `timber.accel` (WCET analysis, SIMD codegen, Ed25519 signing, certification reports, SIMD/GPU/HLS target profiles), and full end-to-end pipelines.

See [`CONTRIBUTING.md`](/kossisoroyce/timber/blob/main/CONTRIBUTING.md) for the full development guide.
...
The full paper is available at [`paper/timber_paper.pdf`](/kossisoroyce/timber/blob/main/paper/timber_paper.pdf).
...
* **Contributing:** [`CONTRIBUTING.md`](/kossisoroyce/timber/blob/main/CONTRIBUTING.md)
* **Code of conduct:** [`CODE_OF_CONDUCT.md`](/kossisoroyce/timber/blob/main/CODE_OF_CONDUCT.md)
* **Security policy:** [`SECURITY.md`](/kossisoroyce/timber/blob/main/SECURITY.md)
* **Changelog:** [`CHANGELOG.md`](/kossisoroyce/timber/blob/main/CHANGELOG.md)
...
[![Buy Me A Coffee](https://camo.githubusercontent.)](https://buymeacoffee.com/electricsheepafrica)
...
Apache-2.0 — see [`LICENSE`](/kossisoroyce/timber/blob/main/LICENSE) for the full text.
