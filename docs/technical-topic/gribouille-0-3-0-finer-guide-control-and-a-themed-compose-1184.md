...
domain: mickael.canouil.fr
source_date: '2026-06-19'
tags:
- github-repo
- web-dev
- tutorial
summary: 'Gribouille 0.3.0 introduces finer control over plot guides, allowing users
  to hide axis ticks and legends independently without modifying themes, while also
  adding a theme parameter to the compose() function for styling multi-panel layouts.
  Key updates include new syntax like guides(x: none) for axis control, the defer()
  helper function replacing plot(..., defer: true), default stacking for geom-area(),
  and the ability for annotations to overflow panel boundaries with clip: false. The
  release prioritizes usability improvements and bug fixes, particularly in legend
  layout and styling.'
...
Another week, another [Gribouille](https://github.com/mcanouil/gribouille) release. Gribouille 0.3.0 is narrower in scope than [0.2](/posts/2026-06-03-gribouille-0-2/), but it brings some wanted controls. The headline is guide control: a single argument now hides axis ticks and legends without touching the theme. Alongside that, `compose()` gains a `theme:` parameter, `defer()` replaces `plot(..., defer: true)`, `geom-area()` stacks by default, and `annotate()` can let marks overflow the panel.
...
[![Penguin scatter of body mass against flipper length with no x-axis tick marks or labels. The vertical grid lines and the axis title 'Flipper Length (mm)' remain.](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/guides-x-none-light.svg)](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/guides-x-none-light.svg "Penguin scatter of body mass against flipper length with no x-axis tick marks or labels. The vertical grid lines and the axis title 'Flipper Length (mm)' remain.")

[![Penguin scatter of body mass against flipper length with no x-axis tick marks or labels. The vertical grid lines and the axis title 'Flipper Length (mm)' remain.](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/guides-x-none-dark.svg)](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/guides-x-none-dark.svg "Penguin scatter of body mass against flipper length with no x-axis tick marks or labels. The vertical grid lines and the axis title 'Flipper Length (mm)' remain.")
...
[![Penguin scatter of body mass against flipper length, coloured by species, with no legend shown.](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/guides-default-none-light.svg)](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/guides-default-none-light.svg "Penguin scatter of body mass against flipper length, coloured by species, with no legend shown.")

[![Penguin scatter of body mass against flipper length, coloured by species, with no legend shown.](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/guides-default-none-dark.svg)](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/guides-default-none-dark.svg "Penguin scatter of body mass against flipper length, coloured by species, with no legend shown.")
...
#plot(
  ...
  layers: (geom-bar(),),
  coord: coord-radial(),
1  guides: guides(theta: none, default: none),
  labs: labs(
...
[![A coxcomb chart of penguin counts by species using coord-radial, with the angular tick labels hidden. Only the radial grid is visible.](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/guides-radial-light.svg)](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/guides-radial-light.svg "A coxcomb chart of penguin counts by species using coord-radial, with the angular tick labels hidden. Only the radial grid is visible.")

[![A coxcomb chart of penguin counts by species using coord-radial, with the angular tick labels hidden. Only the radial grid is visible.](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/guides-radial-dark.svg)](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/guides-radial-dark.svg "A coxcomb chart of penguin counts by species using coord-radial, with the angular tick labels hidden. Only the radial grid is visible.")
...
```
1#let panel(y, title) = defer(plot,
  data: penguins,
...
2
:   `theme: theme-minimal()` styles the title, legend, and tags, and propagates into both panels because neither sets its own theme.

[![Two scatter panels side by side, tagged (1) Body Mass and (2) Bill Length, sharing a species legend at the bottom and a title across the top. The minimal theme is set once on compose().](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/compose-theme-light.svg)](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/compose-theme-light.svg "Two scatter panels side by side, tagged (1) Body Mass and (2) Bill Length, sharing a species legend at the bottom and a title across the top. The minimal theme is set once on compose().")

[![Two scatter panels side by side, tagged (1) Body Mass and (2) Bill Length, sharing a species legend at the bottom and a title across the top. The minimal theme is set once on compose().](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/compose-theme-dark.svg)](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/compose-theme-dark.svg "Two scatter panels side by side, tagged (1) Body Mass and (2) Bill Length, sharing a species legend at the bottom and a title across the top. The minimal theme is set once on compose().")

4 Area stacks by default
------------------------
...
1
:   No `stat:` or `position:` needed. Groups A, B, and C have different x breakpoints; `stat: "align"` resamples them onto a shared grid before stacking.

[![Stacked area chart with three groups A, B, and C over x values 0 to 4. Groups A and B have different x breakpoints; stat-align resamples them onto a shared grid before stacking.](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/geom-area-stack-light.svg)](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/geom-area-stack-light.svg "Stacked area chart with three groups A, B, and C over x values 0 to 4. Groups A and B have different x breakpoints; stat-align resamples them onto a shared grid before stacking.")

[![Stacked area chart with three groups A, B, and C over x values 0 to 4. Groups A and B have different x breakpoints; stat-align resamples them onto a shared grid before stacking.](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/geom-area-stack-dark.svg)](../../posts/2026-06-15-gribouille-0-3/./assets/typst-render/geom-area-stack-dark.svg "Stacked area chart with three groups A, B, and C over x values 0 to 4. Groups A and B have different x breakpoints; stat-align resamples them onto a shared grid before stacking.")

5 Annotations can overflow
--------------------------
...
1
:   `clip: false` keeps the mark visible even though `x = 235` sits past the panel boundary.

6 Under the hood
----------------

As with 0.2, a large share of the release is fixes rather than features. Legend layout was the main focus.
...
* `guide-legend(align:)` now aligns the legend title as well as the entry labels. Passing a plain string such as `"left"` also reports a clear error instead of being silently ignored.
...
* `sqrt` and `log10` transforms validate their domain and report clear errors for out-of-range data. The `sqrt` inverse also clamps padded view bounds at zero so the axis stays monotone and shows the `0` break.
* The out-of-range filter now respects scale `expand`, so points and annotations inside the expansion headroom are kept. Reversed `limits` (a flipped axis) no longer drop every row.
...
7 Editor support: Tinymist docstrings
-------------------------------------

The published package now ships Tinymist-friendly docstrings. Hovering over a gribouille function in a compatible editor shows formatted parameters, return values, and examples, instead of the raw `@`-tag comments. Variadic sinks such as `guides()` and `theme()` list their accepted keys explicitly, so you can see which aesthetics or element surfaces each function takes without opening the reference.
...
Next on the list is more geoms and worked examples. If you run into something unexpected, the issue tracker is the right place for it.
...
Gribouille is an unfunded spare-time project, and the API is still settling. Bug reports and ideas are very welcome on the issue tracker. Pull requests are not being accepted for now, for the reasons set out in the [launch post](/posts/2026-05-20-gribouille-grammar-of-graphics-for-typst/). Thanks in advance for your patience.
...
[CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.en_gb)
...
Themed Compose. *Mickael.canouil.fr*. <https://mickael.canouil.fr/posts/2026-06-15-gribouille-0-3/>
