...
title: Why our website looks like an operating system - PostHog
domain: posthog.com
source_date: '2025-09-12'
tags:
- web-dev
- tutorial
summary: PostHog redesigned its website to function like an operating system, allowing
  users to multitask by opening multiple windows, articles, and demos simultaneously
  instead of relying on traditional single-page scrolling. The design addresses common
  frustrations with technical websites—such as opening numerous indistinguishable
  tabs—by implementing features like window snapping, keyboard shortcuts, and a file
  explorer-style interface. While unconventional and initially jarring, this innovative
  approach improves content consumption and engagement while maintaining technical
  scalability through JSON-based content management and unified customer databases.
...
* [PostHog news](/blog/posthog-news)
...
* Skinning a site with themes *and* color schemes
...
For a lot of this site, I was designing it *while* I was building UIs in Typescript and Tailwind. (The entire site is just a Git branch off our current site – it's all technically the same codebase. I just merged along the way over the last few months.)
...
> PostHog is an all-in-one developer platform for building successful products. We provide [product analytics](/product-analytics), [web analytics](/web-analytics), [session replay](/session-replay), [error tracking](/error-tracking), [feature flags](/feature-flags), [experiments](/experiments), [surveys](/surveys), [AI Observability](/llm-analytics), [logs](/logs), [workflows](/workflows), [endpoints](/endpoints), [data warehouse](/data-warehouse), [CDP](/cdp), and an [AI product assistant](/ai) to help debug your code, ship features faster, and keep all your usage and customer data in one stack.
