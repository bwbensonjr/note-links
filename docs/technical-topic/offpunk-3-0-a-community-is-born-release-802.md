...
- github-repo
- python
summary: Offpunk 3.0, a command-line browser for offline web browsing across Web,
  Gemini, and Gopher protocols, has been released as a community-driven project with
  significant contributions from volunteers beyond the original developer. Key improvements
  include multi-language support, better content extraction from websites, image display
  enhancements, RSS feed discovery, cookie-based login capability, and new social
  sharing features. The release marks a milestone where Offpunk has evolved from a
  solo project into a genuine cooperative effort with an active community contributing
  translations, tools, and packaging support.
...
![Bikepunk logo, for decorative reason](/files/decvt220.jpg)

Offpunk 3.0 "A Community is Born" Release
=========================================

by [Ploum](https://fr.wikipedia.org/wiki/Ploum) on 2026-02-09
...
* [Offpunk, the offline-first command-line browser](gemini://offpunk.net)
...
* [Instructions to install Offpunk](https://offpunk.net/install.html)
* [Dowload Offpunk 3.0](https://git.sr.ht/~lioploum/offpunk/refs/v3.0)
...
* [How to help translating Offpunk (offpunk.net)](https://offpunk.net/translation.html)
...
[![XKCDpunk in action](/files/offpunk3_xkcd.png)](/files/offpunk3_xkcd.png)
...
* [Unmerdify on Codeberg](https://codeberg.org/vjousse/unmerdify)

You can contribute by creating or improving rules for your frequently visited websites.

* [Site Patterns | FiveFilters.org Docs (help.fivefilters.org)](https://help.fivefilters.org/full-text-rss/site-patterns.html#github-repository)
* [fivefilters/ftr-site-config: Site-specific article extraction rules to aid content extractors, feed readers, and 'read later' applications. (github.com)](https://github.com/fivefilters/ftr-site-config)
...
[![Gemini capsule of Thierry Crouzet displayed in Offpunk](/files/gemini_crouzet.png)](/files/gemini_crouzet.png)
...
[![A blocked link to X on standblog.org](/files/standblog_blocked.png)](/files/standblog_blocked.png)
...
- "set default\_cmd" allows you to configure what Offpunk will do when pressing enter on an empty command line. By default, it is "links 10."  
...
* [Come and join the Offpunk community!](https://offpunk.net/help.html)

### About the author

I’m [Ploum](https://fr.wikipedia.org/wiki/Ploum), a writer and an engineer. I like to explore how technology impacts society. You can subscribe [by email](https://listes.ploum.net/mailman3/lists/en.listes.ploum.net/) or [by rss](/atom_en.xml). I value privacy and never share your adress.

I write [science-fiction novels in French](https://pvh-editions.com/ploum). For [Bikepunk](https://bikepunk.fr), my new post-apocalyptic-cyclist book, my publisher is looking for contacts in other countries to distribute it in languages other than French. If you can help, [contact me](about.html)!
