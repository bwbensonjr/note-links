...
title: 'GitHub - apple/container: A tool for creating and running Linux containers
  using lightweight virtual machines on a Mac. It is written in Swift, and optimized
  for Apple silicon. · GitHub'
domain: github.com
...
- devops
- cli-tool
summary: Apple's container is a Swift-based tool designed for Mac users with Apple
  silicon that enables creating and running Linux containers as lightweight virtual
  machines, with full compatibility with OCI-standard container images from any registry.
  The tool requires macOS 26 and provides features for building, running, and publishing
  containerized applications, with installation and management handled through signed
  installer packages and command-line scripts. The project is actively under development
  with potential breaking changes expected until reaching version 1.0.0.
...
[Containerization logo](/apple/container/blob/main/assets/Containerization-Logo.png)
 container
===============================================================================================
...
[![introductory movie showing some basic commands](/apple/container/raw/main/docs/assets/landing-movie.gif)](/apple/container/blob/main/docs/assets/landing-movie.gif)
...
You need a Mac with Apple silicon to run `container`. To build it, see the [BUILDING](/apple/container/blob/main/BUILDING.md) document.
...
* Take [a guided tour of `container`](/apple/container/blob/main/docs/tutorials/start-here.md) by building, running, and publishing a simple web server image.
* Learn how to [use various `container` features](/apple/container/blob/main/docs/how-to.md).
* Read a brief description and [technical overview](/apple/container/blob/main/docs/technical-overview.md) of `container`.
* Browse the [full command reference](/apple/container/blob/main/docs/command-reference.md).
* [Build and run](/apple/container/blob/main/BUILDING.md) `container` on your own development system.
