...
title: 'GitHub - x-motemen/ghq: Remote repository management made easy · GitHub'
domain: github.com
...
- cli-tool
- go
summary: ghq is a command-line tool that organizes and manages cloned remote repositories
  automatically by placing them in a structured directory hierarchy based on their
  URL (e.g., ~/ghq/github.com/user/project). It provides commands to clone repositories
  (ghq get), list local clones (ghq list), remove repositories (ghq rm), and supports
  various Git options like shallow cloning, bare clones, and partial clones. The tool
  is highly configurable through git-config variables and can be installed across
  multiple platforms including macOS, Linux, Windows, and via various package managers.
fetch_status: success
summarizer_model: global.anthropic.claude-haiku-4-5-20251001-v1:0
---

# GitHub - x-motemen/ghq: Remote repository management made easy · GitHub

ghq(1) [Build Status](https://github.com/x-motemen/ghq/actions?workflow=test) [Coverage](https://codecov.io/gh/x-motemen/ghq)
=============================================================================================================================
...
* motemen <[motemen@gmail.com](mailto:motemen@gmail.com)>

  + <https://github.com/sponsors/motemen>
* Songmu <[y.songmu@gmail.com](mailto:y.songmu@gmail.com)>
