...
- tutorial
- web-dev
summary: Steph Ango uses Obsidian as a personal knowledge management system built
  on plain text files organized with minimal folders, heavy internal linking, and
  consistent metadata properties, allowing him to capture thoughts, write essays,
  and publish content while maintaining long-term control over his digital artifacts.
  His bottom-up approach embraces structured chaos through fractal journaling (capturing
  thoughts at multiple time scales), random revisits to old notes, and a consistent
  personal style guide with rules like pluralizing tags and using a 7-point rating
  scale. The system prioritizes speed and laziness over rigid organization, relying
  on backlinks and the quick switcher for navigation rather than folder hierarchies,
  making connections between ideas emerge naturally over time.
