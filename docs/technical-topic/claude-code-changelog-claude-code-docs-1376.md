...
title: Claude Code changelog - Claude Code Docs
...
- cli-tool
- devops
summary: Claude Code version 2.1.278 introduced support for reading AGENTS.md files
  as an alternative to CLAUDE.md for project instructions, along with updates to auto
  mode classifier billing and a server-side classifier option. The changelog documents
  numerous bug fixes and improvements across multiple areas including plugin management,
  session handling, tool functionality, and interface stability, addressing issues
  ranging from crashes and performance problems to edge cases in file editing and
  message handling.
