...
title: 'GitHub - spotify/basic-pitch: A lightweight yet powerful audio-to-MIDI converter
  with pitch bend detection · GitHub'
domain: github.com
...
- cli-tool
- ai
summary: Basic Pitch is a lightweight Python library developed by Spotify for automatic
  music transcription that converts audio files to MIDI format with pitch bend detection.
  Despite its simplicity, it offers competitive accuracy with larger systems while
  supporting polyphonic instruments, multiple audio formats, and works instrument-agnostically
  across macOS, Windows, and Linux. The library is easily installable via pip and
  npm, offers both command-line and programmatic interfaces, and can process audio
  of any length or sample rate.
fetch_status: success
summarizer_model: global.anthropic.claude-haiku-4-5-20251001-v1:0
---

# GitHub - spotify/basic-pitch: A lightweight yet powerful audio-to-MIDI converter with pitch bend detection · GitHub
...
Import `basic-pitch` into your own Python code and run the [`predict`](/spotify/basic-pitch/blob/main/basic_pitch/inference.py) functions directly, providing an `<input-audio-path>` and returning the model's prediction results:
...
If you would like `basic-pitch` orchestrate the generation and saving of our various supported output file types, you may use [`predict_and_save`](/spotify/basic-pitch/blob/main/basic_pitch/inference.py) instead of using [`predict`](/spotify/basic-pitch/blob/main/basic_pitch/inference.py) directly:
...
Contributions to `basic-pitch` are welcomed! See [CONTRIBUTING.md](/spotify/basic-pitch/blob/main/CONTRIBUTING.md) for details.
