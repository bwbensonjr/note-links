...
- llm
- github-repo
summary: Peter Steinberger, creator of the OpenClaw project, is joining OpenAI to
  focus on developing AI agents accessible to everyone, while OpenClaw will transition
  to an independent foundation to remain open source. Steinberger chose OpenAI over
  commercializing OpenClaw into a company because he prioritizes building transformative
  technology over growing a large business, and he believes OpenAI's resources and
  research access provide the fastest path to bringing agents to mainstream users.
  OpenClaw's community and open-source nature will be preserved, with OpenAI already
  committing to sponsor the project and support Steinberger's continued involvement
  with it.
