...
- distributed-systems
- github-repo
summary: This article discusses why traditional read-only sandboxes are becoming obsolete
  for AI agents, introducing Fly.io's new "Sprites" - durable, disposable cloud computers
  that persist between sessions. The key argument is that AI agents like Claude need
  actual computers with persistent storage rather than ephemeral sandboxes, allowing
  them to maintain state and work more efficiently without rebuilding environments
  for each task. The solution offers the convenience of quick creation (1-2 seconds),
  durability, checkpoint/restore capabilities, and automatic idle metering, making
  it more practical for AI agent workflows than traditional containerized approaches.
...
![](/blog/code-and-let-live/assets/sprites.jpg)
...
![](/blog/code-and-let-live/assets/kurtmdm.png?1/2&card&center)
...
Previous post ↓
:   [Litestream VFS](/blog/litestream-vfs/)
