...
- tutorial
- distributed-systems
summary: Software architecture refers to the important design decisions and shared
  understanding among expert developers about a system's internal structure, which
  directly impacts how quickly and cost-effectively new features can be added. Good
  architecture is essential because poor architecture accumulates technical debt that
  slows development and increases defects, whereas high internal quality actually
  leads to faster feature delivery despite common misconceptions that quality costs
  more. The guide explores various architectural approaches including application
  architecture, microservices, legacy system displacement, and micro frontends, emphasizing
  that architecture is ultimately about recognizing and maintaining what matters most
...
with Ralph Johnson](/ieeeSoftware/whoNeedsArchitect.pdf), who questioned this phrasing, arguing that
...
[![](ieee-arch.png)](/ieeeSoftware/whoNeedsArchitect.pdf)

Ralph's email formed the core of [my column for
IEEE software](/ieeeSoftware/whoNeedsArchitect.pdf), which discussed the meaning of software
...
software. Software that contains a lot of cruft [is much harder to modif](/articles/is-quality-worth-cost.html)y, leading to features
that arrive more slowly and with more defects.

[![](/articles/is-quality-worth-cost/card.png)](/articles/is-quality-worth-cost.html)
...
[![](/articles/is-quality-worth-cost/both.png)](/articles/is-quality-worth-cost.html)

[Read more…](/articles/is-quality-worth-cost.html)

[![](oscon.png)](/videos.html#2015-oscon)

At OSCON in 2015 I gave a [brief talk](/videos.html#2015-oscon) (14
...
construction](/bliki/ApplicationBoundary.html):
...
### [Application Boundary](/bliki/ApplicationBoundary.html)
...
[Read more…](/bliki/ApplicationBoundary.html)

bliki

[team organization](/tags/team%20organization.html) [enterprise architecture](/tags/enterprise%20architecture.html) [application architecture](/tags/application%20architecture.html)

### [Microservices Guide](/microservices)

![](/microservices/microservices-sq.png)
...
[application architecture](/tags/application%20architecture.html) [web services](/tags/web%20services.html) [microservices](/tags/microservices.html)

### [Patterns of Legacy Displacement](/articles/patterns-legacy-displacement/)

![](https://martinfowler.com/articles/patterns-legacy-displacement/card.png)

When faced with the need to replace existing software systems,
...
organization to recognize that change is the unvarying reality.

by Ian Cartwright, Rob Horn, and James Lewis

5 Mar 2024

[Read more…](/articles/patterns-legacy-displacement/)

article

[enterprise architecture](/tags/enterprise%20architecture.html) [evolutionary design](/tags/evolutionary%20design.html) [legacy modernization](/tags/legacy%20modernization.html)

### [Micro Frontends](/articles/micro-frontends.html)
...
[Read more…](/articles/micro-frontends.html)
...
### [GUI Architectures](/eaaDev/uiArchs.html)

![]()

Graphical User Interfaces provide a rich interaction between the
user and a software system. Such richness is complex to manage, so it's
important to contain that complexity with a thoughtful architecture. The Forms
and Controls pattern works well for systems with a simple flow, but as it
breaks down under the weight of greater complexity, most people turn to
“Model-View-Controller” (MVC). Sadly MVC is one of the most misunderstood
architectural patterns around, and systems using that name display a range of
important differences, sometimes described under names like Application Model,
Model-View-Presenter, Presentation Model, MVVM, and the like. The best way to
think of MVC is as set of principles including the separation of presentation
from domain logic and synchronizing presentation state through events (the
observer pattern).
...
[Read more…](/eaaDev/uiArchs.html)

article

[design](/tags/design.html) [application architecture](/tags/application%20architecture.html) [front-end](/tags/front-end.html)

### [Serverless Architectures](/articles/serverless.html)
...
[Read more…](/articles/serverless.html)

article

[application architecture](/tags/application%20architecture.html)

### [Presentation Domain Data Layering](/bliki/PresentationDomainDataLayering.html)
...
[Read more…](/bliki/PresentationDomainDataLayering.html)

bliki

[team organization](/tags/team%20organization.html) [database](/tags/database.html) [encapsulation](/tags/encapsulation.html) [application architecture](/tags/application%20architecture.html) [web development](/tags/web%20development.html)
...
can easily lead to inconsistencies. Despite this, many organizations rely on
a range of core distributed software handling data storage, messaging,
system management, and compute capability. These systems face common
problems which they solve with similar solutions. In 2020 Unmesh Joshi began
collecting these solutions as patterns, publishing them on this site as he
developed them. In 2023 these were published in the book Patterns of
Distributed Systems. This page links to short summaries of each
pattern, with deep links to the relevant chapters for the online eBook
publication on oreilly.com

Unmesh Joshi

23 Nov 2023

[Read more…](/articles/patterns-of-distributed-systems/)

catalog

[application architecture](/tags/application%20architecture.html) [microservices](/tags/microservices.html)

### [Feature Toggles (aka Feature Flags)](/articles/feature-toggles.html)
...
[Read more…](/articles/feature-toggles.html)

article

[continuous delivery](/tags/continuous%20delivery.html) [application architecture](/tags/application%20architecture.html)

### [Modularizing React Applications with Established UI Patterns](/articles/modularizing-react-apps.html)

![](https://martinfowler.com/articles/modularizing-react-apps/evolution-5.png)

Established UI patterns are often underutilized in the frontend development world,
despite their proven effectiveness in solving complex problems in UI design.
This article explores the application of established UI building patterns to the
React world, with a refactoring journey code example to showcase the benefits.
The emphasis is placed on how layering architecture can help organize the React
application for improved responsiveness and future changes.

by Juntao QIU | 邱俊涛

16 Feb 2023

[Read more…](/articles/modularizing-react-apps.html)

article

[application architecture](/tags/application%20architecture.html) [front-end](/tags/front-end.html)
...
### [Enterprise Architects Join the Team](/ieeeSoftware/enterpriseArchitects.pdf)

![](/img/catalog/ieee-arch-team.png)
...
[Read more…](/ieeeSoftware/enterpriseArchitects.pdf)

[ieeeSoftware](/tags/ieeeSoftware.html) [enterprise architecture](/tags/enterprise%20architecture.html)

### [Creating an integrated business and technology strategy](/articles/creating-integrated-tech-strategy.html)

![](https://martinfowler.com/articles/creating-integrated-tech-strategy/card.png)

To make fruitful use of technology, we need to align our technology
...
[Read more…](/articles/creating-integrated-tech-strategy.html)

article

[enterprise architecture](/tags/enterprise%20architecture.html) [technical leadership](/tags/technical%20leadership.html)

### [Products Over Projects](/articles/products-over-projects.html)
...
[Read more…](/articles/products-over-projects.html)

article

[enterprise architecture](/tags/enterprise%20architecture.html) [team organization](/tags/team%20organization.html)

### [The Architect Elevator — Visiting the upper floors](/articles/architect-elevator.html)

![](/articles/architect-elevator/taipei101.jpg)
...
[Read more…](/articles/architect-elevator.html)

article

[enterprise architecture](/tags/enterprise%20architecture.html)

### [The Role of an Enterprise Architect in a Lean Enterprise](/articles/ea-in-lean-enterprise.html)
...
[Read more…](/articles/ea-in-lean-enterprise.html)

article

[agile](/tags/agile.html) [enterprise architecture](/tags/enterprise%20architecture.html) [technical leadership](/tags/technical%20leadership.html) [lean](/tags/lean.html)

### [Enterprise Integration Using REST](/articles/enterpriseREST.html)
...
[Read more…](/articles/enterpriseREST.html)

article

[application integration](/tags/application%20integration.html) [web services](/tags/web%20services.html) [enterprise architecture](/tags/enterprise%20architecture.html)
