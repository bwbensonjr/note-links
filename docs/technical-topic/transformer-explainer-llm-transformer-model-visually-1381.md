...
- llm
- tutorial
summary: 'Transformers are a neural network architecture that fundamentally changed
  AI by using a self-attention mechanism to process sequences and predict the next
  token in text generation. The page explains how transformers work through three
  key components: embedding (converting text into numerical vectors with positional
  information), transformer blocks (which process data through multi-head self-attention
  and MLP layers), and output probabilities. Using GPT-2 as an example, it demonstrates
  how transformers break down input text into tokens, assign them semantic meaning
  through embedding vectors, and use attention mechanisms to capture relationships
  between tokens from multiple perspectives, enabling the model to generate coherent
  text predictions.'
...
["Attention is All You Need"](https://dl.acm.org/doi/10.5555/3295222.3295349 "ACM Digital Library")
...
[audio generation](https://huggingface.co/learn/audio-course/en/chapter3/introduction "Hugging Face"),
[image recognition](https://huggingface.co/learn/computer-vision-course/unit3/vision-transformers/vision-transformers-for-image-classification "Hugging Face"),
[protein structure prediction](https://elifesciences.org/articles/82819 "eLife"), and even
[game playing](https://www.deeplearning.ai/the-batch/reinforcement-learning-plus-transformers-equals-efficiency/ "Deep Learning AI"), demonstrating its versatility across numerous domains.
...
[GPT-2](https://huggingface.co/openai-community/gpt2 "Hugging Face")
...
![](./article_assets/embedding.png)

Figure 1. Expanding the Embedding layer view, showing how the
...
![](./article_assets/QKV.png)

QKVij=(∑d=1768Embeddingi,d⋅Weightsd,j)+Biasj
QKV\_{ij} = ( \sum\_{d=1}^{768} \text{Embedding}\_{i,d} \cdot \text{Weights}\_{d,j}) + \text{Bias}\_j
...
* **Dot Product**: The dot product of
  ...
  **attention score**, producing a square matrix that reflects the relationship
...
[nanoGPT project](https://github.com/karpathy/nanoGPT "Github")
...
[Svelte](https://kit.svelte.dev/ "Svelte")
as a front-end framework and
[D3.js](https://d3js.org/ "D3")
