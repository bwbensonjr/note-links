...
title: 'GitHub - false-schemers/siof: SIOF (Scheme In One File) is a minimal interpreter
  for R7RS Scheme'
domain: github.com
...
- c
- compilers
summary: SIOF (Scheme In One File) is a minimal, portable R7RS Scheme interpreter
  that compiles from a single C source file with no external dependencies, making
  it easy to build and deploy across different platforms. While largely R7RS-small
  compatible, it has some limitations such as 30-bit fixnums, no Unicode support,
  and no support for bignums or complex numbers, but it includes essential Scheme
  features like garbage collection, proper tail recursion, and a hygienic macro system.
  The interpreter can be compiled with standard C compilers and offers precompiled
  binaries for various platforms, with optional optimization flags available for improved
  performance.
fetch_status: success
summarizer_model: global.anthropic.claude-haiku-4-5-20251001-v1:0
---

# GitHub - false-schemers/siof: SIOF (Scheme In One File) is a minimal interpreter for R7RS Scheme
