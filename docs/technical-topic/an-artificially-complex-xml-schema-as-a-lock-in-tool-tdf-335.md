---
id: 335
url: https://blog.documentfoundation.org/blog/2025/07/18/artificially-complex-xml-schema-as-lock-in-tool/
title: An artificially complex XML schema as a lock-in tool - TDF Community Blog
domain: blog.documentfoundation.org
source_date: '2025-07-19'
tags:
- security
- politics
summary: The document format XML schema should prioritize simplicity and accessibility,
  but Microsoft 365 deliberately uses an artificially complex XML schema as a vendor
  lock-in strategy to prevent competitors from creating compatible solutions. This
  unnecessary complexity—characterized by deeply nested tags, excessive abstraction,
  and convoluted naming conventions—creates barriers for developers while remaining
  invisible to end users, ultimately trapping customers into Microsoft's ecosystem
  much like a railway system with simple tracks but deliberately incomprehensible
  train controls. The author argues that millions of users have failed to critically
  examine these proprietary technologies, allowing Microsoft to strengthen its monopoly
  through increasingly sophisticated lock-in tactics.
fetch_status: success
summarizer_model: global.anthropic.claude-haiku-4-5-20251001-v1:0
---

# An artificially complex XML schema as a lock-in tool - TDF Community Blog

[![](https://blog.documentfoundation.org/wp-content/uploads/2025/07/Xml_logo.svg_-300x68.png)](https://blog.documentfoundation.org/wp-content/uploads/2025/07/Xml_logo.svg_.png)A document format is a tool for sharing knowledge and, as such, should be as simple and accessible as possible in relation to the complexity of the document content itself. This remains true even when the format is based on an XML schema that is hidden from users when the document is displayed on screen.
