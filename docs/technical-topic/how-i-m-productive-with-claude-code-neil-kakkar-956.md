...
- tutorial
- cli-tool
summary: Neil Kakkar describes how he transformed his development workflow at Tano
  by automating repetitive tasks and optimizing infrastructure to work effectively
  with Claude Code agents. By creating tools like /git-pr for automated pull requests,
  switching to SWC for faster builds, enabling AI-driven UI verification, and building
  a parallel worktree system with port management, he eliminated friction at each
  stage and shifted from individual coding to managing an effective team of agents.
  The key insight is that removing bottlenecks reveals the next constraint, creating
  a tight feedback loop where the real leverage comes from infrastructure improvements
  rather than AI capabilities alone.
...
![Commit history graph over the last 6 weeks](/assets/images/commit-history-graph.png)
...
Then I wrote my first Claude Code skill: `/git-pr`.[1](#fn:1)
...
1. It’s /git-pr because our codebase CLAUDE.md says to use Graphite, but I prefer plain git. [↩](#fnref:1)

### You might also like

* [Agentic Debt](/agentic-debt.html)
* [What I learned about burnout and anxiety at 30](/burnout-anxiety-at-30.html)
* [How to setup duration based profiling in Sentry](/sentry-duration-span-sampling.html)
* [How to simulate a broken database connection for testing in Django](/test-database-connection-django.html)
