...
* Allows [optionally storing the prompt](/minimaxir/gemimg/blob/main/docs/notebooks/store_prompt_metadata.ipynb) in the PNG metadata.
...
[![](/minimaxir/gemimg/raw/main/docs/notebooks/gens/JP28aM2cFOODqtsPi7_J8A0@0.5x.webp)](/minimaxir/gemimg/blob/main/docs/notebooks/gens/JP28aM2cFOODqtsPi7_J8A0@0.5x.webp)
...
[![](/minimaxir/gemimg/raw/main/docs/notebooks/gens/7fm8aJD0Lp6ymtkPpqvn0QU@0.5x.webp)](/minimaxir/gemimg/blob/main/docs/notebooks/gens/7fm8aJD0Lp6ymtkPpqvn0QU@0.5x.webp)
...
[![](/minimaxir/gemimg/raw/main/docs/notebooks/gens/Yfu8aIfpHufVz7IP4_WEsAc@0.5x.webp)](/minimaxir/gemimg/blob/main/docs/notebooks/gens/Yfu8aIfpHufVz7IP4_WEsAc@0.5x.webp)
...
[![](/minimaxir/gemimg/raw/main/docs/notebooks/gens/s57haPv7FsOumtkP1e_mqQM.webp)](/minimaxir/gemimg/blob/main/docs/notebooks/gens/s57haPv7FsOumtkP1e_mqQM.webp)
...
[![](/minimaxir/gemimg/raw/main/docs/notebooks/gens/composite_max.webp)](/minimaxir/gemimg/blob/main/docs/notebooks/gens/composite_max.webp)
...
[![](/minimaxir/gemimg/raw/main/docs/notebooks/gens/6HC-aLCQKc3Vz7IP9eeDyAI@0.5x.webp)](/minimaxir/gemimg/blob/main/docs/notebooks/gens/6HC-aLCQKc3Vz7IP9eeDyAI@0.5x.webp)
...
[![](/minimaxir/gemimg/raw/main/docs/files/pose_control_base.png)](/minimaxir/gemimg/blob/main/docs/files/pose_control_base.png)
...
[![](/minimaxir/gemimg/raw/main/docs/notebooks/gens/qEC-aPT-Joahz7IP07Lo4Qw.webp)](/minimaxir/gemimg/blob/main/docs/notebooks/gens/qEC-aPT-Joahz7IP07Lo4Qw.webp)

[Jupyter Notebook which randomizes the character order](/minimaxir/gemimg/blob/main/docs/notebooks/pose_control.ipynb).

This is just the tip of the iceberg of things you can do with Nano Banana (a blog post is coming shortly). By leveraging Nano Banana's long context window, you can even give it HTML and have it render a webpage ([Jupyter Notebook](/minimaxir/gemimg/blob/main/docs/notebooks/html_webpage.ipynb)). And that's not even getting into JSON prompting of the model, which can offer *extremely* granular control of the generation. ([Jupyter Notebook](/minimaxir/gemimg/blob/main/docs/notebooks/character_json.ipynb))

Grid Generation
---------------

One cost-effective way to generate images is to generate multiple images simultaneously within a single generation at a higher resolution. Nano Banana Pro can generate a contiguous grid of images in a single API call without requiring an input image, which gemimg then automatically slices into individual images. This is cheaper than generating images one at a time through the base Nano Banana, and also benefits from the image quality/adherence improvements of Nano Banana Pro. ([Jupyter Notebook](/minimaxir/gemimg/blob/main/docs/notebooks/grid_generation.ipynb))
...
[![](/minimaxir/gemimg/raw/main/docs/notebooks/gens/9sQnabOuMbyeqtsP7_LXEA.webp)](/minimaxir/gemimg/blob/main/docs/notebooks/gens/9sQnabOuMbyeqtsP7_LXEA.webp)
