...
title: 'GitHub - dabeaz/ply: Python Lex-Yacc'
domain: github.com
...
- compilers
- tutorial
summary: PLY (Python Lex-Yacc) is a zero-dependency Python implementation of traditional
  parsing tools that uses LALR(1) parsing algorithm to build parsers for programming
  languages, creating abstract syntax trees and compilers. However, as of December
  2025, the project has been abandoned after 25 years of development, with the author
  recommending users consider alternative parsing libraries or continue using PLY
  by copying it into their projects. The tool is distributed as two simple files (lex.py
  and yacc.py) with minimal features by design, prioritizing flexibility and simplicity
  for educational and practical parsing tasks.
...
The [doc/](/dabeaz/ply/blob/master/doc) directory has more extensive documentation on PLY.

Examples
--------

The [example/](/dabeaz/ply/blob/master/example) directory has various examples of using PLY.
