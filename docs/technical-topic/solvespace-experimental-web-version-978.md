...
title: SolveSpace - Experimental Web Version
domain: solvespace.com
source_date: '2026-03-31'
tags:
- emulator
- web-dev
- c
summary: SolveSpace is a parametric 2D/3D CAD software that has been experimentally
  ported to run in web browsers using emscripten, allowing users to work with smaller
  models directly in their browser without network dependencies. While the web version
  experiences some performance degradation and contains bugs compared to the desktop
  version, it remains functional for many use cases and can be self-hosted as static
  web content. The experimental nature of this release means users may encounter issues
  specific to the browser version, though bug reports are welcomed.
