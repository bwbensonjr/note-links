...
title: dario, please! - POP RDI; RET;
domain: pop.rdi.sh
...
- politics
- llm
summary: The author critiques Dario Amodei's regulatory proposal for AI, arguing that
  Anthropic and OpenAI's calls for stricter open-weight model regulation are self-serving
  attempts to consolidate power while their own security failures and reckless practices
  undermine their credibility as "stewards" of AI. The piece challenges Amodei's utopian
  claims about AI curing diseases and creating abundance, pointing out that such benefits
  would likely remain gated behind corporate interests while existing problems like
  tuberculosis deaths persist due to distribution failures, not technological limitations.
  Additionally, the author dismisses Amodei's fears about AGI creating planet-scale
  botnets as naive hype, while highlighting that the real concern should be OpenAI's
  documented security incompetence and the companies' competitive "race to the bottom"
  despite their claims of caution.
...
[#ai](https://pop.rdi.sh/tags/ai/) 
[#opinion](https://pop.rdi.sh/tags/opinion/) 
[#security](https://pop.rdi.sh/tags/security/) 
[#policy](https://pop.rdi.sh/tags/policy/)
