...
title: The Wolfram S Combinator Challenge
domain: www.combinatorprize.org
source_date: '2026-02-26'
tags:
- academic-paper
- compilers
summary: The Wolfram Foundation is offering a $20,000 prize for proving or disproving
  Stephen Wolfram's 2020 conjecture that the S combinator alone is computation universal,
  building on Moses Schönfinkel's 1920 discovery that S and K combinators together
  possess this property. Submissions must be original technical research papers with
  rigorous proofs, and the prize goes to the first individual or group to provide
  a satisfactory solution as judged by the prize committee. All eligible participants
  are invited to compete, with submissions remaining open until a correct solution
  is achieved.
...
The S, K combinators defined by Moses Schönfinkel ![](/img/sk-cominators.png)on December 7, 1920, are together known to be computation universal. On December 7, 2020, Stephen Wolfram made the suggestion that S alone might also be universal. This challenge is about proving or disproving that conjecture.

### Background

[A Modern Introduction to Combinators](https://writings.stephenwolfram.com/2020/12/combinators-a-centennial-view/)
...
[The Story of Moses Schönfinkel](https://writings.stephenwolfram.com/2020/12/where-did-combinators-come-from-hunting-the-story-of-moses-schonfinkel/)

### Combinators Book

[*Combinators: A Centennial View* (Stephen Wolfram)](https://www.wolfram-media.com/products/combinators-a-centennial-view.html)
...
[Submit a Solution](/submit-solution)

[Contact Us](/contact-us)
[Press Inquiries](mailto: media@wolframfoundation.org)
[Bibliography](https://www.wolframcloud.com/obj/sw-writings/Combinators/bibliography.pdf)

### Other Wolfram Prizes

[Rule 30 Prizes (Announced 2019)](//www.rule30prize.org/)

[2,3 Turing Machine Prize (Won 2007)](https://www.wolframscience.com/prizes/tm23/)
