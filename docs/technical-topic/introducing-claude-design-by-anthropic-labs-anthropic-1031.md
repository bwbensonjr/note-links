...
- llm
- web-dev
summary: Anthropic has launched Claude Design, a new tool that enables users to collaborate
  with Claude to create visual work like designs, prototypes, and presentations through
  natural conversation and refinement. The tool is powered by Claude Opus 4.7, automatically
  applies team design systems for consistency, and seamlessly integrates with other
  tools like Claude Code and Canva for handoff and further editing. It's now available
  in research preview for Claude Pro, Max, Team, and Enterprise subscribers, allowing
  designers to explore multiple directions quickly and non-designers to produce polished
  visual work without design expertise.
...
Today, we’re launching [Claude Design](https://claude.ai/redirect/website.v1.33a1fedf-5747-4b68-9502-0e04849443fe/design), a new [Anthropic Labs](https://www.anthropic.com/news/introducing-anthropic-labs) product that lets you collaborate with Claude to create polished visual work like designs, prototypes, slides, one-pagers, and more.
...
Start designing at [claude.ai/design](http://claude.ai/redirect/website.v1.33a1fedf-5747-4b68-9502-0e04849443fe/design).
