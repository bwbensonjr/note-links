...
title: Lindenmayer.jl · Lindenmayer
domain: cormullion.github.io
source_date: '2026-02-19'
tags:
- github-repo
- tutorial
summary: Lindenmayer.jl is a Julia package that enables users to design and visualize
  L-Systems (Lindenmayer systems)—recursive rule-based patterns inspired by plant
  growth—using the Luxor.jl graphics library. The package allows users to define L-Systems
  with string replacement rules and an initial state, then render them as visual fractals
  and self-similar patterns by interpreting characters as drawing instructions like
  forward movement, rotation, and color shifts. It provides extensive customization
  options for drawing parameters and supports both simple automated rendering and
  custom integration into broader Luxor workflows.
...
![Example block output](index-b2e0fc47.svg)
...
[Drawing the LSystem](#Drawing-the-LSystem)
-------------------------------------------
...
[Drawing LSystems](#Drawing-LSystems)
-------------------------------------
...
![Example block output](index-38f9a270.png)
...
![Example block output](index-7f1eee89.png)
...
![Example block output](index-991a97b0.svg)
