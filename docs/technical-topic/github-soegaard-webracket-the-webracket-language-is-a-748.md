...
title: 'GitHub - soegaard/webracket: The WebRacket language is a subset of Racket
...
- scheme
- web-dev
summary: WebRacket is a subset of Racket that compiles to WebAssembly, allowing developers
  to write Racket programs that run in browsers and terminals without using JavaScript.
  The project supports a substantial portion of Racket's functionality including basic
  data types, syntactic forms, tail calls, and exceptions, while providing a JavaScript
  FFI with bindings for DOM, Canvas, and other browser APIs. The long-term goal is
  to extend this compiler to support full Racket and eventually integrate WebAssembly
  compilation into the standard Racket compiler.
fetch_status: success
summarizer_model: global.anthropic.claude-haiku-4-5-20251001-v1:0
---

# GitHub - soegaard/webracket: The WebRacket language is a subset of Racket that compiles to WebAssembly
...
[`DESIGN-new-web-api.md`](/soegaard/webracket/blob/main/DESIGN-new-web-api.md).
...
[![MathJax 4 example](/soegaard/webracket/raw/main/assets/screenshots/examples/mathjax4-new.png)](/soegaard/webracket/blob/main/assets/screenshots/examples/mathjax4-new.png)
...
[![Matrix - digital rain example](/soegaard/webracket/raw/main/assets/screenshots/examples/matrix-rain-new.png)](/soegaard/webracket/blob/main/assets/screenshots/examples/matrix-rain-new.png)
...
[![MiniScheme example](/soegaard/webracket/raw/main/assets/screenshots/examples/minischeme-new.png)](/soegaard/webracket/blob/main/assets/screenshots/examples/minischeme-new.png)
...
[![Pict example](/soegaard/webracket/raw/main/assets/screenshots/examples/pict.png)](/soegaard/webracket/blob/main/assets/screenshots/examples/pict.png)
...
[![space invaders example](/soegaard/webracket/raw/main/assets/screenshots/examples/space-invaders-new.png)](/soegaard/webracket/blob/main/assets/screenshots/examples/space-invaders-new.png)
...
[![xtermjs example](/soegaard/webracket/raw/main/assets/screenshots/examples/xtermjs-new.png)](/soegaard/webracket/blob/main/assets/screenshots/examples/xtermjs-new.png)
...
A port of `threading` Alexis King [lexi.lambda@gmail.com](mailto:lexi.lambda@gmail.com) is included.
