---
id: 260
url: https://chameth.com/making-a-font-of-my-handwriting/
...
- tutorial
- web-dev
summary: The author created a custom handwriting font for their personal website to
  make it more unique and personal rather than generic. After struggling with open-source
  tools like FontForge and Inkscape due to their poor user interfaces, they switched
  to Calligraphr, a paid web-based service that works by scanning handwritten letter
  templates and automatically converting them into a font file. Through iterative
  refinement using Calligraphr's user-friendly tools to adjust letter spacing, baseline
  alignment, and add custom ligatures, they successfully created a personalized handwriting
  font that enhances their website's character.
...
more… personal. Little ways to make it obvious it’s *mine* and *personal*,
...
edit images a *lot* more than I edit fonts, and GIMP has actually significantly
...
![Eight scanned template sheets, filled in with handwritten letters and ligatures](/making-a-font-of-my-handwriting/template.jpg)
...
If you’re viewing this post on my website[1](#fn:1), you can see the font in the
headers, captions, and a few other places. Here’s how it compares to my actual
handwriting:

![A hand-written line of text saying 'Hello World! This is Chris Hand' above the same line of text in the Chris Hand font](/making-a-font-of-my-handwriting/sample.jpg)
...
1. And I haven’t changed everything since writing this post… [↩︎](#fnref:1)

This content is also published/discussed on these external sites:

* [Bluesky](https://bsky.app/profile/posts.chameth.com/post/3mdteshekzox3)
* [Hacker News](https://news.ycombinator.com/item?id=45141636)

### Related posts

[![A spaghetti carbonara ready meal, fresh out the microwave](/an-app-can-be-a-ready-meal/readymeal.jpg)
...
[![A grid of Standard Diffusion produced avatars of the author](/infinite-avatars/avatars.jpg)

### Generating infinite avatars

I recently added a new ‘about’ section to the top of my website. Like most about pages, it has a picture. Instead of a normal photograph, however, you’ll see an AI-generated avatar. This is admittedly fairly trendy at the minute — apps like Lensa offer to make you profile pictures if you give them a set of photos and some cash — but I’ve done something a bit dif...](/infinite-avatars/)
[![Word cloud featuring: game, month, post, blog, llms, obsidian, bunch, notes, playing, site, button, track, project, board, write, social, entertainment, alternative, into, llm-generated, near, forgejo, through](/monthly-meanderings-2026-01/wordcloud.png)

### Monthly Meanderings: January 2026

Welcome to the second edition of my monthly meanderings. For a bit of context, you can check out the introduction to the first edition. Website updates It’s been a pretty busy month for chameth.com. Three blog posts: The Meaning of Life — an entry into the IndieWeb carnival where I mostly review a book on Stoicism — Surge Protectors: Marketing vs Reality which is a dump of a rese...](/monthly-meanderings-2026-01/)

[Chris Smith](https://chameth.com/)
![](https://chameth.com/avatar.webp)
MD87
#nobridge

Recently I've been on a small campaign to try to make my personal website
more… personal. Little ways to make it obvious it's \_mine\_ and \_personal\_,
not just another piece of the boring corporate dy...
