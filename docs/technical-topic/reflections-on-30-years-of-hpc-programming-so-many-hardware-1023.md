...
Tags:
[Editorial](../../tags/editorial/)
[History](../../tags/history/)
[Hardware](../../tags/hardware/)
[GPUs](../../tags/gpus/)
[Portability](../../tags/portability/)
[Performance](../../tags/performance/)
[Safety](../../tags/safety/)
[HPSF](../../tags/hpsf/)

By:
[Brad Chamberlain](../../authors/brad-chamberlain)
...
workshop for projects like Chapel that strive to create productive approaches to scalable parallel programming[note:For readers unfamiliar with HIPS, its publications focus on
...
parallel systems and many-core architectures.”].
...
Like so many “*n* years of HPC” retrospectives, let’s start by looking
to the TOP500 list[note:The TOP500 is a ranking of
...
latest results from November 2025.] to see how HPC
...
performance as measured by *Rmax* values ranged from 98.9 to 170
GFlop/s. The following screenshot from the TOP500 website summarizes
these systems and results:

![](../../posts/30years/Top500-Nov1995.png)
...
have jumped to the millions (2,073,600–11,340,000 cores), and *Rmax*
values range from 561 to 1809 PFlop/s:

![](../../posts/30years/Top500-Nov2025.png)
...
MPI, PVM, and SHMEM were the dominant[note:It’s
...
be?] ways of programming distributed-memory systems at
...
largely stayed the same[note:Champions of Fortran,
...
base languages compared to more modern alternatives.],
...
they were able to express parallelism and locality[note:By “express locality”, I mean the ability to control and
...
performance and scalablity on distributed systems.] in
...
they took hold, recurring themes include productivity, safety[note:I’m using “safety” in a broad sense here,
encompassing type safety, memory safety, and/or parallel
safety.], portability, and performance—things that are
...
**“Hold on… are you claiming that language \_\_\_\_\_ is not \_\_\_\_\_?” (click for details)**
...
*sufficient* for HPC, in the sense that the vast majority of notable
...
didn’t really *need* Fortran. Though assembly may have been
...
language that was positioned to be broadly adopted for a variety of reasons[note:Among them: a lack of generality; a
...
* Its features that support the clean expression of algorithms also
  ...
  recent HPSFCon talk, [*The Case for Compiled Languages for
  HPC*](https://youtu.be/e_8wuKXhm6A?si=jhaeFX60o7F2Mnc5) or [its
...
others on my list. Despite those hesitations, I think Chapel *is*
...
productively and efficiently](../../series/7-questions-for-chapel-users/), and we want to replicate that
...
(Redux)](../../series/10-myths-about-scalable-parallel-programming-languages-redux/)
series on this blog, or jump to the [final article’s
summary](../../posts/10myths-part8/#summary) to get the takeaways
