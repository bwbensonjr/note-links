...
- web-dev
- database
summary: 'Nokode is an experimental no-code web application that replaces traditional
  application logic with an LLM and three tools (database, web response, and memory
  management), eliminating the need to write code entirely. While the proof-of-concept
  contact manager successfully demonstrates that LLMs can handle application logic—including
  inventing database schemas, writing SQL, generating UIs, and implementing user feedback—it
  suffers from severe practical limitations: it''s 300-6000x slower, 100-1000x more
  expensive, and prone to hallucinations and memory issues compared to traditional
  applications. The author concludes that while the core capability exists today,
  the barriers are primarily performance-related challenges that may be solvable as
  AI inference speeds improve and costs decrease.'
...
|  |  |  |
| --- | --- | --- |
| [Fresh empty home](/samrolken/nokode/blob/main/screenshots/1.png) | [Filling out a contact form](/samrolken/nokode/blob/main/screenshots/2.png) | [Contact detail view](/samrolken/nokode/blob/main/screenshots/3.png) |
| [Home with three contacts](/samrolken/nokode/blob/main/screenshots/4.png) | [Another contact detail](/samrolken/nokode/blob/main/screenshots/5.png) | [Home with ten contacts](/samrolken/nokode/blob/main/screenshots/6.png) |
| [After deleting a contact](/samrolken/nokode/blob/main/screenshots/7.png) | [Home after delete](/samrolken/nokode/blob/main/screenshots/8.png) | [Evolved contact app](/samrolken/nokode/blob/main/screenshots/9.png) |
