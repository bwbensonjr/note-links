...
[![Crates.io](https://camo.githubusercontent.com/91d46b5249011fc0da241b4acc972c9c322d83248a345fd29c8a05a7d9d5e681/68747470733a2f2f696d672e736869656c64732e696f2f6372617465732f762f627474662e737667)](https://crates.io/crates/bttf)

Dual-licensed under MIT or the [UNLICENSE](https://unlicense.org/).

### Documentation

The [user guide](/BurntSushi/bttf/blob/master/GUIDE.md) should be your first stop for understanding the high level
concepts that bttf deals with. Otherwise, consult `bttf --help` or
`bttf <sub-command> --help` for more specific details.

Alternatively, there is a [comparison](/BurntSushi/bttf/blob/master/COMPARISON.md) between other similar tools that might
...
you likely don't have [locale support](/BurntSushi/bttf/blob/master/GUIDE.md#localization) support configured. Enabling
...
To see more examples, check out the [user guide](/BurntSushi/bttf/blob/master/GUIDE.md) or the [comparison](/BurntSushi/bttf/blob/master/COMPARISON.md) between
...
Or, if you want to disable [locale support](/BurntSushi/bttf/blob/master/GUIDE.md#localization), install without default
features:
...
add tests, bttf makes heavy use of [cargo insta](https://insta.rs/docs/cli/) for snapshot testing. For
