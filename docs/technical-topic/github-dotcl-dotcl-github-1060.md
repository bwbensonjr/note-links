...
* **Writing .NET code in Lisp.** The `dotnet:` package gives direct
  ...
  `(dotnet:invoke sb "Append" "x")`, `(dotnet:static "System.Math" "Sin" 1.0)`. You can subclass .NET types from Lisp via `dotnet:define-class`
...
[`DESIGN.md`](/dotcl/dotcl/blob/master/DESIGN.md).

License
-------

MIT. See [`LICENSE`](/dotcl/dotcl/blob/master/LICENSE).
