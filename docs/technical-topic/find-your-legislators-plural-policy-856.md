...
title: Find Your Legislators - Plural Policy
...
- politics
- database
summary: OpenStates.org, now maintained by Plural Policy, is a free platform that
  helps users find their legislators and search legislation across the United States,
  while also providing open legislative data and APIs for developers. The site is
  committed to making democracy more transparent and accessible by offering bulk data
  downloads, a powerful API with various pricing tiers, and an AI-powered legislation
  tracker with real-time updates and predictive analytics. Users can search for representatives
  by entering their address or access existing accounts and bill tracking tools through
  the platform.
