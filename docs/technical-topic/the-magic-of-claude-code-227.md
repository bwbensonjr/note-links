...
- cli-tool
- tutorial
summary: Claude Code is a powerful AI coding tool that the author has adopted as his
  primary "agentic operating system" for various workflows, particularly note-taking
  with Obsidian. What sets Claude Code apart from competitors like Cursor is its native
  Unix command integration and—most crucially—filesystem access, which gives AI models
  persistent memory and state across conversations, solving the limitations of browser-based
  AI tools. The author demonstrates how this architecture enables innovative applications
  like "Claudesidian" and "Inbox Magic," showing how Claude Code represents a blueprint
  for building reliable AI systems that capture model capabilities rather than constraining
  them through over-engineered interfaces.
...
![Obsidian](https://www.alephic.com/api/media/file/CleanShot%202025-09-30%20at%2009.48.05%402x.png)
...
![Claude Code + Obsidian](https://www.alephic.com/api/media/file/CleanShot%202025-09-30%20at%2009.49.30.gif)
...
The filesystem changes everything. ChatGPT and Claude in the browser have two fatal flaws: no memory between conversations and a cramped [context window](/glossary/context-window). A filesystem solves both. Claude Code writes notes to itself, accumulates knowledge, and keeps running tallies. It has state and memory. It can think beyond a single conversation.
