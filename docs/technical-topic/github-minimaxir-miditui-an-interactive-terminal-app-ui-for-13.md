---
id: 13
url: https://github.com/minimaxir/miditui?tab=readme-ov-file
title: 'GitHub - minimaxir/miditui: An interactive terminal app/UI for MIDI composing,
  mixing, and playback—written in Rust'
domain: github.com
...
- rust
- cli-tool
summary: '**miditui** is an interactive terminal-based MIDI composing, mixing, and
  playback application written in Rust that provides a DAW-like experience with unexpectedly
  advanced features for a terminal app. Key features include a piano roll view, full
  mouse support (click, drag, scroll), real-time keyboard-based music composition
  using a QWERTY layout, unlimited MIDI tracks with mixing controls, timeline seeking,
  and support for importing/exporting MIDI, JSON, and WAV files. The application was
  developed with assistance from an AI coding agent and is now open-source, available
  for download or installation via Rust''s cargo package manager.'
fetch_status: success
summarizer_model: global.anthropic.claude-haiku-4-5-20251001-v1:0
---

# GitHub - minimaxir/miditui: An interactive terminal app/UI for MIDI composing, mixing, and playback—written in Rust

miditui
=======

[![](/minimaxir/miditui/raw/main/docs/header.webp)](/minimaxir/miditui/blob/main/docs/header.webp)
...
[
](https://private-user-images.githubusercontent.com/2179708/533142313-faab0610-e1a8-4c4c-9b94-850fa18aedd3.mp4?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..MT9VPs1V2NxA4Ss-bdzwjXIc7mijVYeZE2iFvyqZDdk)

***Disclosure:** This crate was developed with the assistance of [Claude Opus 4.5](https://www.anthropic.com/news/claude-opus-4-5), initially as a personal experiment just to see how well modern coding agents can handle TUIs and I figured a full-on MIDI mixer which has atypical UI requirements would be a more **interesting** test. Opus 4.5 did a good job and after a demo [went viral on X](https://x.com/minimaxir/status/2005779586676842646) people were asking for me to release it, so I decided to spend extra time polishing and comprehensively testing the app before then open-sourcing it. I have written a full analysis of the agentic coding workflow—including the prompts provided to Opus 4.5—in the [agent\_notes folder](/minimaxir/miditui/blob/main/agent_notes).*
...
If you want example MIDIs for testing and opening them with `Ctrl+O`, you can view the [/examples folder](/minimaxir/miditui/blob/main/examples).
