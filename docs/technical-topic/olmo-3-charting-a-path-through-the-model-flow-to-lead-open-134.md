...
[Models](https://huggingface.co/collections/allenai/olmo-3)[Tech Report](https://allenai.org/papers/olmo3)[Code](https://github.com/allenai/open-instruct/)[API](https://allenai.org/olmo)[Demo](https://playground.allenai.org/)

![](data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxNDQwIiBoZWlnaHQ9IjgxMCI+PC9zdmc+)![](data:image/jpeg;base64,)
...
![](data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxNDcyIiBoZWlnaHQ9IjgxMCI+PC9zdmc+)![](data:image/jpeg;base64,)
...
![](data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxNTUwIiBoZWlnaHQ9Ijc4MSI+PC9zdmc+)![](data:image/jpeg;base64,)
...
Together, Olmo 3.1 Think 32B and Olmo 3.1 Instruct 32B show that openness and performance can advance together. By extending the same model flow, we continue to improve capabilities while retaining end-to-end transparency over data, code, and training decisions. You can [try the new checkpoints in the Ai2 Playground](https://playground.allenai.org/?utm_source=ai2-blog&utm_medium=referral&utm_campaign=olmo3_launch) or [download them from Hugging Face](https://huggingface.co/collections/allenai/olmo-3), or [use them via API](https://allenai.org/olmo) courtesy of our inference partners.
...
As with [Olmo](https://allenai.org/blog/olmo-open-language-model-87ccfc95f580) and [Olmo 2](https://allenai.org/blog/olmo2), we’re making all the components of the Olmo 3 flow openly available to the public—data, code, model weights, and checkpoints.
...
| QA | PopQA | 14.1 | 20.4 | 26.5 | 25.5 | 28.9 |
...
| Improvement | Total tokens (Mtok) | Speed (Tokens/sec) | MFU (%) | MBU (%) |
| --- | --- | --- | --- | --- |
...
[Try Olmo 3 on the Ai2 Playground](https://playground.allenai.org?utm_source=ai2-blog&utm_medium=referral&utm_campaign=olmo3_launch) **|** [Use Olmo 3via OpenRouter](https://openrouter.ai/allenai/) **|** [Download the models & data](https://huggingface.co/collections/allenai/olmo-3-68e80f043cc0d3c867e7efc6) **|** [Read the report](http://allenai.org/papers/olmo3)
