...
title: 'GitHub - nashsu/llm_wiki: LLM Wiki is a cross-platform desktop application
  that turns your documents into an organized, interlinked knowledge base — automatically.
  Instead of traditional RAG (retrieve-and-answer from scratch every time), the LLM
  incrementally builds and maintains a persistent wiki from your sources。 · GitHub'
domain: github.com
...
- ai
- python
summary: LLM Wiki is a cross-platform desktop application that automatically transforms
  documents into an organized, interconnected knowledge base by using large language
  models to incrementally build and maintain a persistent wiki rather than re-deriving
  answers on each query. It enhances Andrej Karpathy's original LLM Wiki pattern with
  features including two-step chain-of-thought ingestion, multimodal image processing,
  a knowledge graph with relevance modeling, community detection, deep research capabilities,
  and a full desktop interface with three-column layout and real-time processing visualization.
  The application maintains source traceability, supports vector semantic search,
  includes a Chrome web clipper, and provides local API and MCP server integration
  for hybrid searching and AI agent integration.
...
[![LLM Wiki Logo](/nashsu/llm_wiki/raw/main/logo.jpg)](/nashsu/llm_wiki/blob/main/logo.jpg)

**A personal knowledge base that builds itself.**  
LLM reads your documents, builds a structured wiki, and keeps it current.

[What is this?](#what-is-this) •
[Features](#what-we-changed--added) •
[Tech Stack](#tech-stack) •
[Installation](#installation) •
[Credits](#credits) •
[License](#license)

English | [中文](/nashsu/llm_wiki/blob/main/README_CN.md) | [日本語](/nashsu/llm_wiki/blob/main/README_JA.md) | [한국어](/nashsu/llm_wiki/blob/main/README_KO.md)

---

[![Overview](/nashsu/llm_wiki/raw/main/assets/overview.jpg)](/nashsu/llm_wiki/blob/main/assets/overview.jpg)
...
[![LLM Wiki Architecture](/nashsu/llm_wiki/raw/main/assets/llm_wiki_arch.jpg)](/nashsu/llm_wiki/blob/main/assets/llm_wiki_arch.jpg)
...
[![Obsidian Compatibility](/nashsu/llm_wiki/raw/main/assets/5-obsidian_compatibility.jpg)](/nashsu/llm_wiki/blob/main/assets/5-obsidian_compatibility.jpg)
...
[![Knowledge Graph](/nashsu/llm_wiki/raw/main/assets/3-knowledge_graph.jpg)](/nashsu/llm_wiki/blob/main/assets/3-knowledge_graph.jpg)
...
[![Louvain Community Detection](/nashsu/llm_wiki/raw/main/assets/kg_community.jpg)](/nashsu/llm_wiki/blob/main/assets/kg_community.jpg)
...
[![Graph Insights](/nashsu/llm_wiki/raw/main/assets/kg_insights.jpg)](/nashsu/llm_wiki/blob/main/assets/kg_insights.jpg)
...
[![Deep Research](/nashsu/llm_wiki/raw/main/assets/1-deepresearch.jpg)](/nashsu/llm_wiki/blob/main/assets/1-deepresearch.jpg)
...
[![Chrome Extension Web Clipper](/nashsu/llm_wiki/raw/main/assets/4-chrome_extension_webclipper.jpg)](/nashsu/llm_wiki/blob/main/assets/4-chrome_extension_webclipper.jpg)
...
* **Local HTTP API** (port 19827, tiny\_http) — Extension ↔ App communication
...
[![Star History Chart](https://camo.githubusercontent.com/a30cbb1a3dd17e5202c25718e06866afe970dedc1521066825ce92edf165bce2/68747470733a2f2f6170692e737461722d686973746f72792e636f6d2f63686172743f7265706f733d6e61736873752f6c6c6d5f77696b6926747970653d64617465266c6567656e643d746f702d6c656674)](https://www.star-history.com/?repos=nashsu%2Fllm_wiki&type=date&legend=top-left)

License
-------

This project is licensed under the **GNU General Public License v3.0** — see [LICENSE](/nashsu/llm_wiki/blob/main/LICENSE) for details.
