...
- ai
- tutorial
summary: As AI-generated code becomes increasingly prevalent, Markdown should be treated
  as source code rather than documentation and stored in a standardized `/src/md`
  directory alongside generated code. This approach preserves the intent and specifications
  of software systems in a human-readable, diffable format that both developers and
  AI agents can easily access, rather than having that critical information scattered
  across ephemeral prompts, wikis, and chat threads. The proposed convention would
  organize Markdown files by feature, data model, API, and infrastructure, with code
  and tests derived from these specifications rather than from temporary prompting
  sessions.
...
[The Missing Source Code](#the-missing-source-code)
---------------------------------------------------
...
[Markdown As Source](#markdown-as-source)
-----------------------------------------
...
[What About Linear/Wikis/etc.?](#what-about-linear-wikis-etc)
-------------------------------------------------------------
...
[What `/src/md` Markdown Looks Like](#what-src-md-markdown-looks-like)
----------------------------------------------------------------------
...
[A Proposed `/src/md` Convention](#a-proposed-src-md-convention)
----------------------------------------------------------------
