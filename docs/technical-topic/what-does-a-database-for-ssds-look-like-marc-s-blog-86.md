...
title: What Does a Database for SSDs Look Like? - Marc's Blog
...
- academic-paper
- distributed-systems
summary: 'Marc Brooker explores how database design should evolve for modern SSDs
  and cloud infrastructure, rather than relying on designs from the spinning disk
  era of the 1990s-2000s. Using quantitative analysis based on the "Five Minute Rule"
  and modern hardware capabilities, he argues that optimal databases should: maintain
  RAM caches for ~30-second access windows, use 32kB as the optimal transfer size
  for SSDs, replicate writes across availability zones to ensure durability, and leverage
  modern datacenter networks and hardware clocks for low-latency consistency at scale.
  The key takeaway is that while some core database principles remain valid, the dramatic
  improvements in SSD performance, network bandwidth, and infrastructure demand reconsidering
  foundational design decisions like write-ahead logs and page sizes.'
...
3. Sorry [ARIES](https://web.stanford.edu/class/cs345d-01/rl/aries.pdf).
...
* 04 Oct 2022 » [Atomic Commitment: The Unscalability Protocol](/blog/2022/10/04/commitment.html)
* 25 Mar 2021 » [What You Can Learn From Old Hard Drive Adverts](/blog/2021/03/25/latency-bandwidth.html)
* 11 Feb 2012 » [Latency lags bandwidth](/blog/2012/02/11/latency-lags-bandwidth.html)

#### Something Completely Different

* 28 Jul 2020 » [A Story About a Fish](/blog/2020/07/28/fish.html)
