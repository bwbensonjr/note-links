...
- tutorial
- compilers
summary: This article introduces **Lean**, a programming language designed to formalize
  mathematics by treating proofs as code that can be verified, composed, and shared.
  The author explains Lean's core concepts through practical examples, starting with
  simple reflexivity proofs (like proving 2 = 2) and progressing to how axioms work—demonstrating
  that adding a false axiom (like "2 = 3") allows mathematicians to prove anything,
  mirroring historical mathematical crises like the contradictions discovered in early
  20th-century set theory. The key takeaway is that Lean enables rigorous, computer-verifiable
  mathematics, but highlights how critical it is to choose correct axioms as a foundation.
...
But if you’re a programmer, you might notice a hint of something else. That `theorem` looks suspiciously like a function. But then what is `2 = 2`? It looks like a return type of that function. But how can `2 = 2` be a *type*? Isn’t `2 = 2` just a boolean? And if `2 = 2` really *is* a type, what are the *values* of that `2 = 2` type? [These are very interesting questions](/beyond-booleans/), but we’ll have to forget about them for now.
...
![Goal is 2 = 2](/the-math-is-haunted/./state1.png)
...
![No goals](/the-math-is-haunted/./state2.png)
...
![](/the-math-is-haunted/./state3.png)
...
![](/the-math-is-haunted/./state4.png)
...
### [#The Math Is Haunted](#the-math-is-haunted)
...
![](/the-math-is-haunted/./state7.png)
...
![](/the-math-is-haunted/./state8.png)
...
![](/the-math-is-haunted/./state9.png)
...
![](/the-math-is-haunted/./state10.png)
...
[Discuss on Bluesky](https://bsky.app/profile/danabra.mov/post/3lv7i6rjttc2t)  ·  [Fork on Tangled](https://tangled.org/@danabra.mov/overreacted/blob/main/public/the-math-is-haunted/index.md?code=true)
