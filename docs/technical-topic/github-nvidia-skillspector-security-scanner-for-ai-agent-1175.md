...
title: 'GitHub - NVIDIA/SkillSpector: Security scanner for AI agent skills. Detect
  vulnerabilities, malicious patterns, and security risks. · GitHub'
domain: github.com
...
- cli-tool
- llm
summary: SkillSpector is an NVIDIA security scanner that detects vulnerabilities and
  malicious patterns in AI agent skills before installation, addressing the finding
  that 26.1% of skills contain vulnerabilities and 5.2% show malicious intent. It
  offers multi-format scanning capabilities (Git repos, URLs, zip files, directories),
  analyzes 64 vulnerability patterns across 16 categories using both static analysis
  and optional LLM semantic evaluation, and provides multiple output formats including
  JSON, Markdown, and SARIF reports with risk scoring. The tool can be installed via
  pip or run in Docker, supports integration with various LLM providers for enhanced
  analysis, and includes live CVE vulnerability lookups via OSV.dev.
...
[![Python 3.12+](https://camo.githubusercontent.com/d447d7d53910a2d345c72845df16d927da9d7cdf1063cd4861c3d0b5eefea808/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f707974686f6e2d332e31322b2d626c75652e737667)](https://www.python.org/downloads/)
[![License: Apache 2.0](https://camo.githubusercontent.com/a549a7a30bacba7bfceebdc207a8e86c3f2c02995a2527640dca30048fd2b64e/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f4c6963656e73652d417061636865253230322e302d626c75652e737667)](https://www.apache.org/licenses/LICENSE-2.0)
...
* **[Development guide](/NVIDIA/SkillSpector/blob/main/docs/DEVELOPMENT.md)** — Architecture, package layout, and how to extend the analyzer pipeline.
...
Run SkillSpector without installing Python by building it locally from the included [Dockerfile](/NVIDIA/SkillSpector/blob/main/Dockerfile). The image is based on the Docker Official Python `3.12-slim-bookworm` image.
