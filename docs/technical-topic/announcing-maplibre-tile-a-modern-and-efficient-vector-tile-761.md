...
Authors:  [Bart Louwers](/about/bart-louwers)  [Ramya Ragupathy](/about/ramya-ragupathy)

Today we are happy to announce **MapLibre Tile** (MLT), a new modern and efficient vector tile format.

![MapLibre Tile Support](/_astro/mlt.CaGKYWCo_1VYzVE.webp)

[What is MapLibre Tile?](#what-is-maplibre-tile)
------------------------------------------------
...
large (planet-scale) 2D and 2.5 basemaps. This current implementation offers feature parity with MVT[1](#user-content-fn-1) while delivering on the following:
...
[this talk](https://www.youtube.com/watch?v=YHcoAFcsES0) or read [this publication](https://dl.acm.org/doi/10.1145/3748636.3763208) by MLT inventor Markus Tremmel.
...
1. One exception: unlike MVT, MLT does not support layers where a value in a column changes type from feature to feature. [↩](#user-content-fnref-1)
