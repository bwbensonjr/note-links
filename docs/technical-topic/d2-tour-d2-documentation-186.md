...
- tutorial
- web-dev
summary: '# D2 Tour Summary


  D2 is a declarative diagram scripting language that converts plain text into visual
  diagrams automatically. Users can write simple text descriptions of what they want
  diagrammed, and D2 generates the corresponding image, with a CLI tool available
  for easy creation and a watch mode for real-time updates. The tour takes 5-10 minutes
  to complete and includes interactive examples that can be tested directly in the
  D2 Playground.'
