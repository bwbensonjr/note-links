...
title: 'GitHub - zakirullin/files.md: 🌱 Private, quiet space for thinking. A simple
  app for your .md files. · GitHub'
domain: github.com
source_date: '2026-05-18'
tags:
- github-repo
- web-dev
summary: Files.md is an open-source, privacy-focused note-taking app designed as a
  lightweight alternative to Obsidian, storing all data as plain Markdown files locally
  on your device with no server uploads. The app emphasizes deep thinking and genuine
  knowledge growth over complex features, offering simple tools for notes, journals,
  tasks, checklists, and habits while supporting optional cloud synchronization through
  existing services or a self-hosted server. It's designed to be minimal, extensible
  by AI, and encourages intentional knowledge work rather than the false sense of
  productivity that can come from overly complex personal knowledge management systems.
fetch_status: success
summarizer_model: global.anthropic.claude-haiku-4-5-20251001-v1:0
---

# GitHub - zakirullin/files.md: 🌱 Private, quiet space for thinking. A simple app for your .md files. · GitHub
...
[![](https://github.com/zakirullin/files.md/raw/main/web/img/bot.png)](https://github.com/zakirullin/files.md/raw/main/web/img/bot.png)
...
[![](https://github.com/zakirullin/files.md/raw/main/web/img/journal.png "Journaling")](https://github.com/zakirullin/files.md/raw/main/web/img/journal.png)
...
[![](https://github.com/zakirullin/files.md/raw/main/web/img/task.png "Adding a task")](https://github.com/zakirullin/files.md/raw/main/web/img/task.png)
...
| **[Self-hosted sync server](/zakirullin/files.md/blob/main/docs/your-own-server.md)** | Your own (or local) server | Yes | One Go binary | Sync between devices inside your network |
...
[Deploy on your own server](/zakirullin/files.md/blob/main/docs/your-own-server.md)  
[Chatbot](/zakirullin/files.md/blob/main/docs/bot.md)  
[Sync flow](/zakirullin/files.md/blob/main/docs/sync-flow.md)  
[End-to-end tests](/zakirullin/files.md/blob/main/docs/e2e-tests.md)
