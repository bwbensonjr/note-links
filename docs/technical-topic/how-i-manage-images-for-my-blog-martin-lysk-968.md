...
title: How I manage Images for my Blog | Martin Lysk
domain: blog.lysk.tech
source_date: '2026-03-30'
tags:
- web-dev
- cli-tool
- tutorial
summary: Martin Lysk automated his blog image management by creating a custom Excalidraw
  VSCode extension that automatically exports frames as SVGs in both light and dark
  modes whenever he makes edits. After initially using a GitHub Action workflow that
  was slow and required pushing changes to see results, he developed a more efficient
  local solution where he simply wraps design elements in frames with an "export_"
  prefix, and the extension instantly generates the corresponding SVG files for use
  in his blog posts.
...
![export](/assets/images/export.dark.exp-252e0eacdb94f7d74ecc629f7c4ea4da.svg#gh-dark-mode-only)
![export](/assets/images/export.light.exp-9ea347e12c4c7c5d619086eb6016a934.svg#gh-light-mode-only)

Using Excalidraw[​](#using-excalidraw "Direct link to Using Excalidraw")
------------------------------------------------------------------------
...
Image © [Randall Munroe, XKCD.com](https://xkcd.com/)

First approach - the GitHub action[​](#first-approach---the-github-action "Direct link to First approach - the GitHub action")
------------------------------------------------------------------------------------------------------------------------------
...
### Problems with approach 1[​](#problems-with-approach-1 "Direct link to Problems with approach 1")
...
A new Idea: Add auto-export to Excalidraw[​](#a-new-idea-add-auto-export-to-excalidraw "Direct link to A new Idea: Add auto-export to Excalidraw")
--------------------------------------------------------------------------------------------------------------------------------------------------
...
### Live preview locally[​](#live-preview-locally "Direct link to Live preview locally")
...
![export](/assets/images/use_exported_images.dark.exp-85113bdc0a31376a46189505f3f9cab1.svg#gh-dark-mode-only)
![export](/assets/images/use_exported_images.light.exp-c445da3239c1ad6a4cfbdddefa04e124.svg#gh-light-mode-only)
