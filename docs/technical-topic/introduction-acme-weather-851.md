...
domain: acmeweather.com
source_date: '2026-02-21'
tags:
- web-dev
- video
summary: Acme Weather is a new weather app created by the former developers of Dark
  Sky, designed to address common frustrations with existing weather applications
  by emphasizing forecast uncertainty through alternate possible outcomes, community
  reporting, comprehensive maps, and customizable notifications. The app distinguishes
  itself by showing users multiple plausible weather scenarios rather than a single
  prediction, helping them better understand forecast reliability and plan accordingly.
  Available on iOS with Android coming soon, Acme Weather costs $25/year and prioritizes
  user privacy by refusing to collect unnecessary data or sell information to third
  parties.
fetch_status: success
summarizer_model: global.anthropic.claude-haiku-4-5-20251001-v1:0
---

# Introduction - Acme Weather

Introducing Acme Weather
========================

[Adam Grossman](mailto:adam@acmeweather.com) February 16, 2026
...
![Acme Weather App](/img/intro/main.png)
...
![A forecast showing multiple possible outcomes](/img/intro/timeline-high-spread.png)
...
![A more reliable forecast](/img/intro/timeline-low-spread.png)
A more reliable forecast

![A less reliable forecast](/img/intro/timeline-high-spread.png)
...
![Community reports](/img/intro/community.png)
Community reports
...
![A more reliable forecast](/img/intro/map-radar.png)

![A less reliable forecast](/img/intro/map-temperature.png)

![A less reliable forecast](/img/intro/map-precip-totals.png)
...
We take your privacy very seriously. Please review our [privacy policy](/privacy), but here is our philosophy in a nutshell:
...
Acme Weather is  in the iOS App Store, and we plan on offering an Android version soon (if you’re an Android developer and would like help, [drop us a line](/jobs)!) The app is a $25/year subscription, with a two-week free trial.
