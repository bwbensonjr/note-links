...
title: 'GitHub - haykgrigo3/TimeCapsuleLLM: A LLM trained only on data from the 19th
  century'
domain: github.com
...
- ai
- python
summary: '**TimeCapsuleLLM** is a GitHub project that trains language models from
  scratch exclusively on historical data from specific time periods and locations
  to eliminate modern bias and authentically capture the language, vocabulary, and
  worldview of that era. The project has released multiple versions (v0-v2) with progressively
  improving results, currently trained on 90GB of 1800-1875 London texts, demonstrating
  capabilities like recalling historical events and generating era-appropriate writing
  styles. The methodology, called Selective Temporal Training (STT), differs from
  fine-tuning approaches because it trains from scratch rather than building on pre-trained
  models, ensuring the AI genuinely reflects historical perspectives rather than merely
  mimicking them.'
fetch_status: success
summarizer_model: global.anthropic.claude-haiku-4-5-20251001-v1:0
---

# GitHub - haykgrigo3/TimeCapsuleLLM: A LLM trained only on data from the 19th century
...
[![TimeCapsuleLLM Sample Output](https://github.com/haykgrigo3/TimeCapsuleLLM/raw/main/london_1800_1850_v0/timelockllm_sample_output.png?raw=true)](https://github.com/haykgrigo3/TimeCapsuleLLM/blob/main/london_1800_1850_v0/timelockllm_sample_output.png?raw=true)
...
[![TimeCapsuleLLM Sample Output](https://github.com/haykgrigo3/TimeCapsuleLLM/raw/main/london_1800_1875_v0.5/fellowcitizens.png?raw=true)](https://github.com/haykgrigo3/TimeCapsuleLLM/blob/main/london_1800_1875_v0.5/fellowcitizens.png?raw=true)
...
At first I assumed that a protest might have coincidentally taken place the same year but take a look at this: [![1834protest](/haykgrigo3/TimeCapsuleLLM/raw/main/1834protest.png)](/haykgrigo3/TimeCapsuleLLM/blob/main/1834protest.png)
...
[![TimeCapsuleLLM Sample Output](https://github.com/haykgrigo3/TimeCapsuleLLM/raw/main/london_1800_1875_v2/v2output1.png)](https://github.com/haykgrigo3/TimeCapsuleLLM/blob/main/london_1800_1875_v2/v2output1.png)

[![TimeCapsuleLLM Sample Output](https://github.com/haykgrigo3/TimeCapsuleLLM/raw/main/london_1800_1875_v2/v2output2.png)](https://github.com/haykgrigo3/TimeCapsuleLLM/blob/main/london_1800_1875_v2/v2output2.png)
...
[![Pronoun bias](https://github.com/haykgrigo3/TimeCapsuleLLM/raw/main/london_1800_1875_v2mini_eval1/pronoun_bias.png)](https://github.com/haykgrigo3/TimeCapsuleLLM/blob/main/london_1800_1875_v2mini_eval1/pronoun_bias.png)

[![Geographic bias](https://github.com/haykgrigo3/TimeCapsuleLLM/raw/main/london_1800_1875_v2mini_eval1/geographic_bias.png)](https://github.com/haykgrigo3/TimeCapsuleLLM/blob/main/london_1800_1875_v2mini_eval1/geographic_bias.png)

[![Temporal bias](https://github.com/haykgrigo3/TimeCapsuleLLM/raw/main/london_1800_1875_v2mini_eval1/temporal_bias.png)](https://github.com/haykgrigo3/TimeCapsuleLLM/blob/main/london_1800_1875_v2mini_eval1/temporal_bias.png)
...
* Run train\_tokenizer.py or train\_tokenizer\_hf.py on the cleaned data.
