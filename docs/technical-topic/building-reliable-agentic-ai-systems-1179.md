...
- distributed-systems
- academic-paper
summary: Bayer AG and Thoughtworks developed PRINCE, an agentic AI system that transforms
  preclinical drug discovery by evolving from keyword-based search to an intelligent
  research assistant capable of answering complex questions and drafting regulatory
  documents. The platform combines Retrieval-Augmented Generation and multi-agent
  workflows to integrate decades of safety study reports, with a focus on reliability
  through context engineering (shaping information flow between agents) and harness
  engineering (building orchestration, error recovery, and observability). PRINCE
  demonstrates how production-ready AI systems can maintain governance and compliance
  while significantly improving research efficiency and data accessibility in the
