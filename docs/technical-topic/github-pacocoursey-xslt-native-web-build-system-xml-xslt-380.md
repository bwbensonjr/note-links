---
id: 380
url: https://github.com/pacocoursey/xslt
title: 'GitHub - pacocoursey/xslt: Native web build system (XML+XSLT)'
domain: github.com
...
- web-dev
- devops
summary: XSLT is a native, zero-configuration web build system that uses XML data
  files with XSLT stylesheets to generate static HTML directly in the browser, eliminating
  the need for complex build tools like Hugo or Next.js. The author proposes using
  web browsers as the build system itself, leveraging the XSLT specification (native
  to all browsers) to transform XML documents into HTML without requiring JavaScript.
  This approach offers simplicity and adherence to web standards while maintaining
  the ability to distribute static files with features like loops, variables, and
  imports.
