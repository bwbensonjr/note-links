...
- web-dev
- nonfiction-book
summary: Fast software—meaning applications that respond instantly with minimal lag—is
  a critical indicator of engineering quality and user trust that's often undervalued
  in software development. Craig Mod illustrates this through examples like nvALT
  (which he trusts implicitly for its speed) versus Ulysses (which occasionally slows
  down, causing him to doubt its reliability), arguing that speed is intrinsically
  linked to whether users perceive an application as well-crafted or bloated. He demonstrates
  how software that unbloats and improves over time, like Sublime Text and Figma,
  builds user confidence and loyalty, while bloated applications like modern Photoshop
  and Google Maps lose users to faster, more focused alternatives despite their feature
  richness.
...
Originally published by: [Roden 028](https://craigmod.com/roden/028/)
...
I can go on and on. But let’s end with an example of a piece of iOS software that is pure craft: [Things](https://apps.apple.com/us/app/things-3-for-ipad/id904244226). Things on iPad and iPhone is one of the most tactile, fast-as-you-can-move apps around. Each animation is purposeful. Mainly, it is *fun*. It’s a fun app to be in. To put stuff into, to rearrange. It is old. Things has been around for over ten years. I was glad to open it ten years ago, and I am glad to open it today.[5](#fn:5)
...
1. It looks like nvALT is finally being updated! nv … [ULTRA](https://brettterpstra.com/2019/04/10/codename-nvultra/)? [↩︎](#fnref:1)
2. When dealing with large bodies of text across many files, organization is everything. I love that Ulysses uses normal folders but keeps track of how you want the files ordered. Unlike, say. Scrivener, which turns your writing project into a giant, proprietary database. So 90% of why I use Ulysses is for this organizational freedom. 5% is for the editor’s simplicity. 5% for the syncing between devices. [↩︎](#fnref:2)
3. Ulysses [responded on Twitter](https://twitter.com/ulyssesapp/status/1153699442454880258): “Yes, the adaptive background color in macOS causes a severe performance drop in longer sheets. We already filed a bug report with Apple and hope they fix it in a future OS update. Workarounds are: Use Light Mode or another theme than D14 or split your sheets.” [↩︎](#fnref:3)
4. Ex: If you tapped on a station in Tokyo, the button to get directions to that station was, at one point, in the top right corner of the screen, a place the directions buttons never otherwise appears [↩︎](#fnref:4)
5. The only other app I’ve found to achieve this same level of tactility and craft was Facebook’s bizarre but delightful [Paper](https://en.wikipedia.org/wiki/Facebook_Paper) experiment, spearheaded by craftsman extraordinaire, [Mike Matas](http://www.mikematas.com/#!g9/pV1o8AKxG/photos/iceland_-_1_of_4). And before paper, [Our Choice](http://pushpoppress.com/ourchoice/), also from Mike and co. [↩︎](#fnref:5)

This essay, originally published July 2019 by [Roden 028](https://craigmod.com/roden/028/). Thoughts? Email [me@craigmod.com](mailto:me@craigmod.com).
