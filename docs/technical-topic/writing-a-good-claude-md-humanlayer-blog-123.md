...
domain: www.humanlayer.dev
source_date: '2025-11-30'
tags:
- llm
- tutorial
- web-dev
summary: 'This article explains how to write an effective CLAUDE.md file to help AI
  coding agents understand your codebase. The key principle is that LLMs are stateless
  and only know what you explicitly tell them in each session, making CLAUDE.md the
  ideal place to onboard Claude with information about your project''s **what** (tech
  stack and structure), **why** (purpose and goals), and **how** (development workflows).


  The main takeaway is to keep CLAUDE.md concise and universally applicable—ideally
  under 300 lines—because LLMs ignore irrelevant context and have limited instruction-following
  capacity (about 150-200 instructions). The article recommends using "progressive
  disclosure" by linking to separate, task-specific documentation files rather than
