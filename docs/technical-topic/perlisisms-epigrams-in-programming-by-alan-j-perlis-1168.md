...
domain: www.cs.yale.edu
source_date: '2026-06-14'
tags:
- academic-paper
- tutorial
summary: Alan Perlis's "Epigrams in Programming" is a collection of 74 witty and thought-provoking
  observations about programming, computer science, and software development. The
  epigrams offer practical wisdom on topics ranging from code structure and language
  design to programmer mindset, covering principles like favoring simplicity, standardizing
  idioms, and recognizing that complexity is often an inherent part of programming
  rather than something to be eliminated entirely. Through clever wordplay and philosophical
  reflection, Perlis critiques programming practices while emphasizing that great
  programming is more about completeness of analysis and accumulated experience than
  raw ingenuity or logic alone.
