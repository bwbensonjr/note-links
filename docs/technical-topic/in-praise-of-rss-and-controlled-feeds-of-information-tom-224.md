...
- tutorial
- cli-tool
summary: The article advocates for RSS (Really Simple Syndication) as a superior alternative
  to algorithm-driven social media feeds. RSS allows users to curate and control exactly
  what content they consume in a chronological, distraction-free format, rather than
  being subject to platforms' engagement-optimizing algorithms that prioritize ads
  and time spent over informed decision-making. The author provides practical tips
  for getting started with RSS readers and demonstrates how this simple technology
  restores user agency over their information diet.
...
EDIT: Hello, [Hacker News](https://news.ycombinator.com/item?id=45459233)! Thrilled to be on the front page.  
EDIT 2: Check out my follow-up article on [how to discover new RSS feeds](https://blog.burkert.me/posts/rss_discovery_strategies/).
