...
title: 'GitHub - borski/travel-hacking-toolkit: AI-powered travel hacking with points,
  miles, and award flights. Drop-in skills and MCP servers for OpenCode and Claude
  Code. · GitHub'
domain: github.com
...
- llm
- python
summary: The Travel Hacking Toolkit is an AI-powered system that helps users find
  optimal flight deals by searching award availability across 25+ loyalty programs,
  comparing against cash prices, and checking loyalty balances to determine whether
  to use points or pay cash. It provides drop-in skills and MCP (Model Context Protocol)
  servers compatible with OpenCode and Claude Code, including five free services (Skiplagged,
  Kiwi, Trivago, Ferryhopper, Airbnb) plus optional paid integrations like Seats.aero
  for award flight search and SerpAPI for cash price comparisons. The toolkit includes
  pre-built travel data, workflow guidance, and example prompts to streamline travel
  research and booking decisions.
fetch_status: success
summarizer_model: global.anthropic.claude-haiku-4-5-20251001-v1:0
---

# GitHub - borski/travel-hacking-toolkit: AI-powered travel hacking with points, miles, and award flights. Drop-in skills and MCP servers for OpenCode and Claude Code. · GitHub
...
| [Airbnb](https://github.com/openbnb-org/mcp-server-airbnb) | Search Airbnb listings, property details, pricing. Includes geocoding fix, property type filter, and DISABLE\_GEOCODING opt-out. | None (free) |
...
These skills require an external account or API key signup. See [`.env.example`](/borski/travel-hacking-toolkit/blob/main/.env.example) for the full list of env vars (some skills require an env var without a real signup, e.g. `scandinavia-transit` needs an `ENTUR_CLIENT_NAME` you choose yourself for Entur's required identification header).
...
| [`ghcr.io/borski/aa-miles-check`](https://github.com/borski/travel-hacking-toolkit/pkgs/container/aa-miles-check) | `american-airlines` | AAdvantage balance and elite status. AwardWallet does not support AA. | [skills/american-airlines](/borski/travel-hacking-toolkit/blob/main/skills/american-airlines/Dockerfile) |
| [`ghcr.io/borski/amex-travel`](https://github.com/borski/travel-hacking-toolkit/pkgs/container/amex-travel) | `amex-travel` | Amex MR portal for flights, hotels, IAP discounts, FHR/THC benefits. Requires Platinum. | [skills/amex-travel](/borski/travel-hacking-toolkit/blob/main/skills/amex-travel/Dockerfile) |
| [`ghcr.io/borski/chase-travel`](https://github.com/borski/travel-hacking-toolkit/pkgs/container/chase-travel) | `chase-travel` | Chase UR portal for flights, hotels, Points Boost, Edit benefits. Requires Sapphire. | [skills/chase-travel](/borski/travel-hacking-toolkit/blob/main/skills/chase-travel/Dockerfile) |
| [`ghcr.io/borski/sw-fares`](https://github.com/borski/travel-hacking-toolkit/pkgs/container/sw-fares) | `southwest` | SW fare classes, points pricing, Companion Pass. Change flight price drop monitor. | [skills/southwest](/borski/travel-hacking-toolkit/blob/main/skills/southwest/Dockerfile) |
| [`ghcr.io/borski/ticketsatwork`](https://github.com/borski/travel-hacking-toolkit/pkgs/container/ticketsatwork) | `ticketsatwork` | TicketsAtWork (EBG) corporate-perks portal. Hotels, theme park tickets, attractions, live events. Often beats portals by 10-30%. | [skills/ticketsatwork](/borski/travel-hacking-toolkit/blob/main/skills/ticketsatwork/Dockerfile) |
...
See [CONTRIBUTING.md](/borski/travel-hacking-toolkit/blob/main/CONTRIBUTING.md) for: the skill addition flow, frontmatter rules, smoke test details, hard-rules list, and house style.
