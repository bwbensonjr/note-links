...
domain: grantslatton.com
source_date: '2025-08-03'
tags:
- tutorial
- web-dev
summary: A design document is a technical report meant to convince readers that a
  proposed design is optimal given specific constraints and trade-offs. The key to
  writing effective design documents is organizing information clearly so readers
  never feel surprised, anticipating objections preemptively, and ruthlessly editing
  for brevity—treating the document like a logical proof where each paragraph builds
  obviously from the previous one. Success requires significant practice and a commitment
  to clarity over cleverness, using techniques like short paragraphs with single main
  ideas and appendices for complex supporting details.
...
This essay is a version of [the response](https://x.com/GrantSlatton/status/1829941438848909778) I gave to my friend Vik's call for suggestions:

> had a lot of people ask how they can learn to write design docs, and i didn’t have a good answer besides “work at a place with writing culture and smart senior engineers”. anyone have more useful advice? <https://t.co/7F9BV31shv>
>
> — vik (@vikhyatk) [August 31, 2024](https://twitter.com/vikhyatk/status/1829873886957355139?ref_src=twsrc%5Etfw)
