...
*Paul Hudson, [@twostraws](https://mastodon.social/@twostraws), October 22nd 2025*
...
The end result is live now: it’s called **Hacktivate**, and it’s available on iPhone, iPad, and Mac. It’s available in two editions:

* [One-time upfront payment, with no in-app purchases](https://apps.apple.com/gb/app/hacktivate-education-edition/id6754342195)
* [Free to play, with in-app purchases for the game and hints](https://apps.apple.com/gb/app/hacktivate-capture-the-flag/id6748286602). (Players can also earn hints completely free!)
...
**Note:** There’s a separate version of Hacktivate that removes all in-app purchases, instead relying on a single, upfront purchase. If you work at schools where in-app purchases aren’t possible, you should download [Hacktivate: Education Edition](https://apps.apple.com/gb/app/hacktivate-education-edition/id6754342195) instead.
...
However, the vast majority of the app was written by me, by hand, because AI just isn’t very good at being original. I wanted challenges that felt *crafted* and *intentional*, so that users could feel their progression grow over time, as opposed to just throwing out a couple of hundred random AI ideas.
...
Here’s a [video of the C&C installer from their remastered edition](https://youtube.com/watch?v=-eDt_Q1risk) – I think the parallels are pretty clear!

Where it goes next
------------------

My goal is obviously *not* to create a horde of black hat hackers, but instead to create something that’s fun and engaging, to provide opportunities for students to learn in a safe way, and I hope also to inspire new people to consider cybersecurity as a career – with all the recent hacks on Jaguar Land Rover, Asahi, F5, and similar, the demand has never been higher.
...
I’ll also keep trying to refine the iPhone UI. The app is *really* packed with functionality, and getting that down to a phone-sized screen was no mean feat.

![An iPhone running Hacktivate, showing the world map.](/img/framed-iphone-1.png)
![An iPhone running Hacktivate, showing a web browser with HTML source code.](/img/framed-iphone-2.png)
![An iPhone running Hacktivate, showing documentation for the BEEP assembly language.](/img/framed-iphone-6.png)
...
* Email: [[email protected]](/cdn-cgi/l/email-protection#a8d8c9ddc4e8c0c9cbc3c1c6cfdfc1dcc0dbdfc1cedc86cbc7c5)
...
[Email Me](/cdn-cgi/l/email-protection#5424352138143c35373f3d3a33233d203c27233d32207a373b39)
