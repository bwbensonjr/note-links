...
trifold[¶](#trifold "Permanent link")
=====================================
...
`trifold` offers an easy alternative to services like Cloudflare Pages, Netlify, and GitHub pages for static websites.
...
bunny.net & pricing[¶](#bunnynet-pricing "Permanent link")
----------------------------------------------------------

At the moment [bunny.net](https://bunny.net?ref=h2lzic0ige)[1](#fn:1) is the only supported provider, but others can be added.
...
1. This is a referral link, using it supports development of the project. [↩](#fnref:1 "Jump back to footnote 1 in the text")
