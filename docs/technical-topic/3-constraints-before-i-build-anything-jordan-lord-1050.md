...
domain: jordanlord.co.uk
source_date: '2026-04-27'
tags:
- tutorial
- web-dev
summary: 'Jordan Lord outlines three key constraints he uses before building anything
  to maintain simplicity and focus: a one-page document that captures the core vision
  and prevents scope creep, a separable core technology that compounds value over
  time independent of product pivots, and a defining constraint that shapes product
  identity and reduces feature bloat. These constraints function as creativity enablers
  that collapse the decision space and force builders to think strategically about
  leverage and originality rather than building complex, unfocused products.'
