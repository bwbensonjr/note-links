...
title: 'FAWK: LLMs can write a language interpreter | Martin Janiczek'
domain: martin.janiczek.cz
...
- tutorial
- github-repo
summary: 'Martin Janiczek created **FAWK**, a functional extension of the AWK programming
  language, using Claude (via Cursor Agent) to build a full interpreter in a single
  day. The project demonstrates that modern LLMs can successfully implement complex
  language features like first-class arrays, lambda functions, lexical scoping, and
  pipeline operators—capabilities that traditional AWK lacks but that functional programming
  enthusiasts would find valuable.


  While impressed by the LLM''s capabilities, Janiczek acknowledges trade-offs: he
  lacks deep familiarity with the generated codebase and must now focus on code review
  rather than writing, raising questions about maintainability and whether LLM-assisted
  development is sustainable for long-term projects.'
...
*(recommended!)*, I was planning to try [AWK](https://en.wikipedia.org/wiki/AWK)
...
I *knew* I’m addicted to the combination of algebraic data types (tagged unions)
...
like *accidental complexity*; things that I’d take for granted in more modern
languages.
...
an interpreter that could run *those specific examples*), and over the course
...
As the cool kids say, I have to *update my priors.* The frontier of what the
LLMs can do has moved since the last time I tried to vibe-code something. I
didn’t expect to have a working interpreter *the same day* I dreamt of a new
...
thing and write tests for it, and I only *really* reviewed the tests. I reckon
...
*rewrite it in Rust* and have a decent chance of success?
...
Writing your own BEAM](/2025/11/09/writing-your-own-beam.html "Writing your own BEAM")[>

Next Post

The LLM spectrum and responsible LLM use](/2026/02/05/the-llm-spectrum-and-responsible-llm-use.html "The LLM spectrum and responsible LLM use")

[Archive](https://martin.janiczek.cz/index.html "Blog Archive")

[Bluesky](https://bsky.app/profile/janiczek.cz "Bluesky")
[Github](https://github.com/janiczek "Github")
