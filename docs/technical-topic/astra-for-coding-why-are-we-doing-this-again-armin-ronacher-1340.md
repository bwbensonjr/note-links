...
title: 'Astra for Coding: Why Are We Doing This Again? | Armin Ronacher''s Thoughts
  and Writings'
...
- llm
- python
summary: Armin Ronacher critiques GPT-6's Astra model for software engineering, arguing
  that despite its impressive capabilities, it represents "involution"—increased effort
  without proportional productivity gains. His experiment running an AI-powered software
  factory for 35 hours burned billions of tokens but produced no useful code, revealing
  that Astra tends to generate questionable code patterns, particularly using excessive
  Python string manipulation instead of proper tools, which suggests potential issues
  in its training process that reward long-horizon task completion without penalizing
  poor code quality.
...
OpenAI models [1](#fn-1). I have since encountered the same issues with regular
...
that Astra is amazing [at producing 3D stuff](https://developers.openai.com/blog/how-to-build-games-with-astra) and it
...
1. I should clarify that I have done experiments like this before. Typically
   ...
   still digestible piece of software.[↩](#fnref-1)

This entry was tagged
[ai](/tags/ai/) and
[thoughts](/tags/thoughts/)

[copy as](/2026/9/7/astra-why.md) / [view](/2026/9/7/astra-why.md) markdown
