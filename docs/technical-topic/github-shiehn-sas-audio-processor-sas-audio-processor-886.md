...
[![SAS Audio Processor](/shiehn/sas-audio-processor/raw/main/assets/sas-audio-engine-graphic.png)](/shiehn/sas-audio-processor/blob/main/assets/sas-audio-engine-graphic.png)
...
* Builds self-contained binaries for **ARM64** (Apple Silicon) and **x86\_64** (Intel)
...
GPL-3.0-or-later — see [`../LICENSE`](/shiehn/sas-audio-processor/blob/LICENSE).
