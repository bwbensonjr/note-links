...
title: Exploring a Modern SMTPE 2110 Broadcast Truck With My Dad - Jeff Geerling
...
- distributed-systems
- video
summary: Jeff Geerling toured a modern SMPTE 2110 broadcast truck at St. Louis Blues
  hockey games to explore the digital infrastructure and timing systems that power
  live sports broadcasts. The truck relies on precision timing protocol (PTP) and
  Evertz grandmaster clocks to synchronize video, audio, and metadata across the network,
  with engineers manually setting time using atomic clock apps since GPS is unreliable
  in mobile venues. Beyond the technology, Geerling was most impressed by the skilled
  broadcast professionals and their coordinated teamwork to deliver high-quality productions,
  operating the complex equipment seamlessly behind the scenes.
fetch_status: success
summarizer_model: global.anthropic.claude-haiku-4-5-20251001-v1:0
---

# Exploring a Modern SMTPE 2110 Broadcast Truck With My Dad - Jeff Geerling
...
![Broadcast production room in 45 Flex truck at a Blues game](/blog/2026/exploring-a-modern-smpte-2110-broadcast-truck-with-my-dad/blues-game-production-truck-prod-room.jpg)

I wanted to explore the timing and digital side of a modern [SMPTE 2110](https://www.smpte.org/standards/st2110) mobile unit, and my Dad has been involved in studio and live broadcast for decades, so he enjoyed the experience as the engineer *not* on duty!
...
![Broadcast production room in 45 Flex truck at a Blues game](/blog/2026/exploring-a-modern-smpte-2110-broadcast-truck-with-my-dad/joseph-geerling-headset-broadcast-truck.jpg)
...
![Evertz master clocks on 45 Flex SMPTE 2110 broadcast truck](/blog/2026/exploring-a-modern-smpte-2110-broadcast-truck-with-my-dad/evertz-master-clocks-45flex.jpg)
...
![Tektronix PRISM in 45 Flex truck](/blog/2026/exploring-a-modern-smpte-2110-broadcast-truck-with-my-dad/tektronix-prism-in-45-flex-truck.jpg)
...
Studios and datacenters are fixed infrastructure, and you can plan out a GPS antenna location and cable routing as part of the buildout. But in live event broadcast, where the truck moves from place to place, you're not guaranteed a clear view of the sky, and can't rely on venue timing signals[1](#fn:1).

So inside the 45 Flex, Chris most often sets the clock manually, accurate to within a second. Apparently they only need true *world* time if they're synchronizing with more than one truck, or across multiple event spaces (e.g. at the Olympics). Otherwise, the 'precision' in PTP is good enough, and doesn't depend on the accuracy of the actual time (in comparison to UTC, TIA, etc.).
...
Inside the truck, there's more fiber and Ethernet cabling than SDI and analog audio—though that doesn't always extend *outside* the truck.
...
![Enterprise Center patch bay on game day](/blog/2026/exploring-a-modern-smpte-2110-broadcast-truck-with-my-dad/patch-bay-enterprise-center.jpg)
...
In the middle there are dozens of yellow fiber patches for data and video routing, and on the right side was a connector entirely new to me, called a [SMPTE connector](https://www.lemo.com/int_en/solutions/specialties/3k-93c-y-smpte-hybrid.html) (or, if you want to get *really* technical, "3K.93C.Y").

![Enterprise Center patch bay on game day](/blog/2026/exploring-a-modern-smpte-2110-broadcast-truck-with-my-dad/smtpe-connector-in-enterprise-center.jpg)
...
![Tony West operating the robocam at a Blues game](/blog/2026/exploring-a-modern-smpte-2110-broadcast-truck-with-my-dad/tony-west-hands-on-robocam-controls.jpg)

But coming out of the experience, the thing that impressed me most was all the human touches, and the team *using* this equipment.

Like Tony West (pictured above, at the primary robocam's controls): he works to get every shot on the camera that's *always* closest to the action (hovering slightly over the ice), and doesn't have to think about the cabling and timing signals making his camera integrate seamlessly with the rest of the system.
...
1. The Enterprise Center *does* have its own robust timing infrastructure, with redundant grandmaster clocks, and two separate GPS antennas—but routing the building's timing signal into the truck is not as convenient as relying on the trucks' own signal for its own broadcast equipment. [↩︎](#fnref:1)

Further reading:
----------------

* [A PTP Wall Clock is impractical and a little too precise](/blog/2026/ptp-wall-clock-impractical-too-precise/)
