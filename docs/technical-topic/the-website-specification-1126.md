...
[Browse all 128 topics →](/spec/) [Get the checklist](/checklist/) [★ on GitHub](https://github.com/jdevalk/specification.website)
...
* [### Foundations
  ...
  The HTML, head, and document basics every page needs.](/spec/foundations/)
* [### SEO

  13

  Search visibility — robots.txt, sitemaps, canonicals, structured data.](/spec/seo/)
* [### Accessibility

  20

  WCAG-aligned rules so people of all abilities can use the site.](/spec/accessibility/)
* [### Security

  12

  Headers, transport, and policies that keep visitors safe.](/spec/security/)
* [### Well-Known URIs

  9

  Standard, agreed-upon paths under /.well-known/.](/spec/well-known/)
* [### Agent Readiness

  18

  Things that make a site legible to AI agents and crawlers.](/spec/agent-readiness/)
* [### Performance

  19

  Core Web Vitals, caching, images, fonts, network behaviour.](/spec/performance/)
* [### Privacy

  6

  Consent, signals, and respecting visitor choice.](/spec/privacy/)
* [### Resilience

  5

  Graceful failure — error pages, offline, redirects.](/spec/resilience/)
* [### Internationalisation

  12

  Language, locale, direction, and translated content.](/spec/i18n/)
...
The whole spec is available as an open [MCP](https://modelcontextprotocol.io/) server — read-only, no auth — plus a published [Agent Skill](/.well-known/agent-skills/specification-website/SKILL.md) that teaches any compatible agent when and how to use it. Per-page Markdown is available via `/llms.txt` and `Accept: text/markdown` on any spec URL.

[Connect MCP →](/mcp/) [Agent Skill](/.well-known/agent-skills/index.json) [llms.txt](/llms.txt) [Agent-readiness spec →](/spec/agent-readiness/)
...
1. 01
   ...
   Run through the [checklist](/checklist/). Each item is a “does the site do this — yes or no.”
2. 02
