...
- llm
- news
summary: 'There is a stark divide emerging between AI users: "power users" who actively
  adopt advanced tools like Claude Code for diverse tasks across departments, and
  casual users limited to basic chatbots like ChatGPT. Enterprise organizations face
  a critical disadvantage due to restrictive IT policies, outdated legacy systems,
  and poor AI tools like Microsoft Copilot, while smaller companies with better APIs
  and flexibility are gaining unprecedented competitive advantages, creating a situation
  where tiny teams can now outperform much larger enterprises.'
...
> To really underline this, Microsoft itself is rolling out Claude Code to internal teams[[1]](#fn1), despite (obviously) having access to Copilot at near zero cost, and significant ownership of OpenAI. I think this sums up quite how far behind they are
...
The security concerns are real. You definitely do not want people YOLOing coding agents over production databases with no control, and [as I've covered](https://martinalderson.com/posts/why-sandboxing-coding-agents-is-harder-than-you-think/), sandboxing agents is *difficult*[[2]](#fn2).
...
On the other you have a non-technical executive who's got his head round Claude Code and can run e.g. Python locally. I helped one recently almost one-shot[[3]](#fn3) converting a 30 sheet mind numbingly complicated Excel financial model to Python with Claude Code.
...
1. [Microsoft is using Claude Code internally while selling you Copilot](https://blog.devgenius.io/microsoft-is-using-claude-code-internally-while-selling-you-copilot-d586a35b32f9) [↩︎](#fnref1)
2. Let's keep in mind that users already have access to these systems. CISOs need to figure out how to enable these kind of secure VMs en masse. There's already precedent for this with Codespaces - it just requires a similar approach scaled up to the entire organisation. [↩︎](#fnref2)
3. Two or three prompts got it there, using plan mode to figure out the structure of the Excel sheet, then prompting to implement it. It even added unit tests to the Python model itself, which I was impressed with! [↩︎](#fnref3)
