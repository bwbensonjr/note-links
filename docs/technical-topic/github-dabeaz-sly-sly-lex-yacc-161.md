...
title: 'GitHub - dabeaz/sly: Sly Lex Yacc'
domain: github.com
...
- python
- compilers
summary: SLY (Sly Lex-Yacc) is a pure Python implementation of traditional lex and
  yacc parser-building tools that uses the LALR(1) algorithm for parsing. It offers
  extensive error reporting, supports Python metaprogramming for defining lexers and
  parsers without code generation, and can handle complex grammars suitable for real
  programming languages. However, the project has been retired as of December 2025,
  with the author recommending users explore other modern Python parsing libraries
  or continue using SLY independently.
...
* [Reinventing the Parser Generator](https://www.youtube.com/watch?v=zJ9z6Ge-vXs), talk by David Beazley at PyCon 2018, Cleveland.
...
To contact me directly, send email to [dave@dabeaz.com](mailto:dave@dabeaz.com) or contact
