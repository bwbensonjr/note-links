---
id: 1187
url: https://shapeofthesystem.com/posts/2026/02/03/bounded-cognition.html
title: Engineering for Bounded Cognition
domain: shapeofthesystem.com
source_date: '2026-06-28'
tags:
- tutorial
- psychology
- web-dev
summary: 'Software engineers face an inherent paradox: they build systems with tens
  of millions of lines of code using minds that can only consciously hold about four
  things at a time, with narrow attention and poor memory retention. Rather than viewing
  human errors as individual failures, good engineering treats cognitive limitations
  as a permanent condition and solves them through structural design—clear naming,
  defined boundaries, tests, and reversible changes that offload cognitive burden
  from the fragile human mind onto the system itself. This principle applies equally
  to humans and machines, including AI models with fixed context windows, making the
  real challenge of engineering not finding a bigger mind but shaping systems that
  small minds can safely work with.'
...
3 February 2026 [cross-cutting](../../../cross-cutting/index.html)
...
* **[Cowan 2001]** Nelson Cowan, "The Magical Number 4 in Short-Term Memory: A Reconsideration of Mental Storage Capacity". Behavioral and Brain Sciences 24(1), 2001. <https://doi.org/10.1017/S0140525X01003922>. The working-memory limit is about four chunks, not seven; tenet [PREAMBLE](../../../../index.html#preamble).
* **[Liu et al. 2023]** Nelson F. Liu, Kevin Lin, John Hewitt, Ashwin Paranjape, Michele Bevilacqua, Fabio Petroni & Percy Liang, "Lost in the Middle: How Language Models Use Long Contexts". arXiv:2307.03172, 2023 (later TACL vol. 12, 2024). <https://arxiv.org/abs/2307.03172>. Models attend to the ends and lose the middle of long contexts; tenet [PREAMBLE](../../../../index.html#preamble).
* **[Miller 1956]** George A. Miller, "The Magical Number Seven, Plus or Minus Two". Psychological Review 63(2), 1956. <https://doi.org/10.1037/h0043158>. Working-memory limit behind 'what an engineer must hold in their head'; tenet [PREAMBLE](../../../../index.html#preamble).
* **[OXO Good Grips 1990]** OXO Good Grips, founded by Sam Farber after watching his wife Betsey struggle with a peeler, designed with Smart Design. 1990. <https://en.wikipedia.org/wiki/Sam_Farber>. Designing for the constrained case makes the tool better for everyone; tenet [PREAMBLE](../../../../index.html#preamble).
* **[Peterson & Peterson 1959]** Lloyd Peterson & Margaret Peterson, "Short-Term Retention of Individual Verbal Items". Journal of Experimental Psychology 58(3), 1959. <https://doi.org/10.1037/h0049234>. Unrehearsed items decay within seconds; tenet [PREAMBLE](../../../../index.html#preamble).
* **[Simons & Chabris 1999]** Daniel Simons & Christopher Chabris, "Gorillas in Our Midst: Sustained Inattentional Blindness for Dynamic Events". Perception 28(9), 1999. <https://doi.org/10.1068/p281059>. Focused attention makes the obvious invisible; tenet [PREAMBLE](../../../../index.html#preamble).
* **[Simons & Levin 1998]** Daniel Simons & Daniel Levin, "Failure to Detect Changes to People During a Real-World Interaction" (the 'door study'). Psychonomic Bulletin & Review 5(4), 1998. <https://doi.org/10.3758/BF03208840>. Change blindness: half miss a swapped conversation partner; tenet [PREAMBLE](../../../../index.html#preamble).

*This is the root of a series of field notes on building software for the way minds actually work: tired, distractible, ordinary, and now partly machine. The full set of moves is the manifesto they come from, [The Shape of the System](https://shapeofthesystem.com).*
