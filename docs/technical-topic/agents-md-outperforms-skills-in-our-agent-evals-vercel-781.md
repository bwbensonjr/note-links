...
- llm
- web-dev
summary: 'Vercel tested two approaches for giving AI coding agents access to updated
  framework documentation: a "skills" system and an AGENTS.md markdown file with embedded
  docs. While skills seemed like the better design choice, they failed to deliver—agents
  ignored them 56% of the time and only achieved 79% accuracy even with explicit instructions.
  In contrast, a compressed 8KB docs index embedded directly in AGENTS.md achieved
  a perfect 100% pass rate, suggesting that passive context availability outperforms
  active retrieval systems for coding agents.'
...
[Link to heading](#building-evals-we-could-trust)**Building evals we could trust**
----------------------------------------------------------------------------------
...
[Link to heading](#the-hunch-that-paid-off)**The hunch that paid off**
----------------------------------------------------------------------
...
[Link to heading](#the-results-surprised-us)**The results surprised us**
------------------------------------------------------------------------
...
[Link to heading](#try-it-yourself)**Try it yourself**
------------------------------------------------------
