...
- llm
- python
summary: This is Andrej Karpathy's comprehensive course on building neural networks
  from scratch in code, progressing from fundamental concepts like backpropagation
  to modern language models like GPT. The course uses language modeling as the primary
  learning vehicle, as it effectively teaches deep learning principles that transfer
  to other domains like computer vision. The curriculum includes hands-on implementations
  of increasingly complex architectures—from basic neural networks and MLPs to convolutional
  networks and transformers—with a focus on understanding the underlying mechanics
  rather than just using libraries.
