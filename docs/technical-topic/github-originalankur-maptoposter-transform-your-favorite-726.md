...
title: 'GitHub - originalankur/maptoposter: Transform your favorite cities into beautiful,
  minimalist designs. MapToPoster lets you create and export visually striking map
  posters with code.'
domain: github.com
...
- cli-tool
- tutorial
summary: MapToPoster is a Python tool that generates beautiful, minimalist map posters
  for any city worldwide by fetching OpenStreetMap data and rendering it with customizable
  themes. The project offers 17 pre-built visual themes (ranging from noir to neon
  cyberpunk to japanese ink) and allows users to control map radius, styling, and
  create custom themes via JSON configuration. It's designed for easy command-line
  usage and includes detailed documentation for developers looking to extend functionality
  with new map layers or themes.
...
[![](/originalankur/maptoposter/raw/main/posters/singapore_neon_cyberpunk_20260118_153328.png)](/originalankur/maptoposter/blob/main/posters/singapore_neon_cyberpunk_20260118_153328.png)

[![](/originalankur/maptoposter/raw/main/posters/dubai_midnight_blue_20260118_140807.png)](/originalankur/maptoposter/blob/main/posters/dubai_midnight_blue_20260118_140807.png)
...
| Spain | Barcelona | warm\_beige |  |
| Italy | Venice | blueprint |  |
| Japan | Tokyo | japanese\_ink |  |
| India | Mumbai | contrast\_zones |  |
| Morocco | Marrakech | terracotta |  |
| Singapore | Singapore | neon\_cyberpunk |  |
| Australia | Melbourne | forest |  |
| UAE | Dubai | midnight\_blue |  |
| USA | Seattle | emerald |  |
