...
- llm
- tutorial
summary: Successful AI research requires balancing reading and hands-on building rather
  than excelling at either alone, combined with disciplined persistence since insights
  arrive unpredictably. The author emphasizes focusing on fundamental concepts and
  deep understanding rather than chasing trendy topics or benchmarks, while maintaining
  an open mind and learning from both successful and failed experiments with equanimity.
  Beyond technical work, inspiration often strikes during non-research activities,
  and great research typically demands hundreds of hours of unglamorous foundational
  work before achieving breakthroughs.
...
So you want to do AI research? It’s true that no one *really* teaches you how. Not directly, anyway. The way to get started is pretty simple: some combination of (i) reading and (ii) building stuff. You can’t do one without the other. You become a researcher through the combination.
