...
- tutorial
- ai
summary: 'This article demystifies AI coding assistants by showing how to build a
  functional coding agent in just 200 lines of Python. The core concept is simple:
  the LLM doesn''t actually modify your code—it sends tool requests (read file, list
  files, edit file) in a structured format, and your program executes them locally,
  then feeds the results back to the LLM in a loop. The author demonstrates that while
  production tools like Claude Code have additional capabilities, three basic tools
  are sufficient to create a powerful coding assistant that feels magical but is fundamentally
  just a structured conversation between an LLM and a tool executor.'
...
[![emperor has no clothes](/static/emperor_no_clothes-74ca6bae4decd3746d45fec249cad830-36f83.jpeg)](/static/emperor_no_clothes-74ca6bae4decd3746d45fec249cad830-36f83.jpeg)
...
Agent calls *edit\_file* with path=“hello.py”, old\_str="", new\_str=“print(‘Hello World’)”
...
Agent calls *read\_file* to see current contents. Agent calls *edit\_file* to add the function.
...
* [ai](/tags/ai/)
* [llm](/tags/llm/)
* [coding-agents](/tags/coding-agents/)
