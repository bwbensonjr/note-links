...
![Rahul M. Juliato](https://avatars.githubusercontent.com/u/16169950?s=400&u=e79b2220a9b9edfe6bd2a92e709d63d7bf97be72)

Rahul M. Juliato

![Cover Image for Two Years of Emacs Solo: 35 Modules, Zero External Packages, and a Full Refactor](/_next/image?url=%2Fassets%2Fblog%2Fposts%2Femacs-solo-two-years.png&w=3840&q=75)
...
I've been maintaining [Emacs Solo](https://github.com/LionyxML/emacs-solo)
...
code is sketchy sometimes, sure, but it's **in my control**. I wrote
...
after expansion. I wrote a [whole article about it](https://www.rahuljuliato.com/posts/abbrev-mode).
...
— Custom server programs, including **rassumfrassum** for
multiplexing TypeScript + ESLint + Tailwind (I wrote [a whole post
about that](https://www.rahuljuliato.com/posts/eglot-rass))
...
MELPA counterparts. They're trying to be **small, understandable,
and good enough** for daily use while keeping the config
self-contained.
...
upload it to the [0x0.st](https://0x0.st) paste service. The URL
...
**Weather forecast from wttr.in.** Fetches weather data from
[wttr.in](https://wttr.in) and displays it in an Emacs buffer.
...
language Y?" and get an answer from [cheat.sh](https://cheat.sh)
...
**Khard contacts browser.** Browse and search your
[khard](https://github.com/lucc/khard) address book from inside
...
people like **Eli Zaretskii**, **Yuan Fu**, **Stéphane Marks**, **João
...
To **Protesilaos Stavrou (Prot)**, whose work on Modus themes, Denote,
...
And to **Gopar (goparism)**, whose Emacs content and enthusiasm for
