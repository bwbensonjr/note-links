...
- compilers
- github-repo
summary: Rhombus v1.0 is a new general-purpose, functional, and extensible programming
  language built on Racket that combines conventional syntax with powerful metaprogramming
  capabilities through a macro system inspired by Lisp. The language aims to balance
  accessibility for everyday programming with advanced extensibility features, offering
  modern programming constructs like closures, pattern matching, and type parametricity
  while enabling domain-specific language development. Rhombus is intended for production
  use with the stability and community support of Racket, and it represents a synthesis
  of functional programming with practical language design rather than an academic
  or teaching-only project.
