---
id: 770
url: https://pandas.pydata.org/community/blog/pandas-3.0.html
...
- github-repo
- database
summary: pandas 3.0 has been released with major improvements including a dedicated
  string data type that replaces the object dtype, Copy-on-Write mode for more predictable
  and consistent behavior, and a new default datetime resolution of microseconds instead
  of nanoseconds. The release includes some breaking changes that may require code
  updates, particularly around string type inference and chained assignment patterns,
  so users are advised to first upgrade to pandas 2.3 and ensure their code works
  without warnings before migrating to 3.0.
...
pandas 3.0 released! [#](#pandas-30-released "Permanent link")
==============================================================
...
Highlights of pandas 3.0 [#](#highlights-of-pandas-30 "Permanent link")
-----------------------------------------------------------------------
...
Upgrading to pandas 3.0 [#](#upgrading-to-pandas-30 "Permanent link")
---------------------------------------------------------------------
...
### 1. Dedicated string data type by default [#](#1-dedicated-string-data-type-by-default "Permanent link")
...
### 2. Consistent copy/view behaviour with Copy-on-Write (CoW) [#](#2-consistent-copyview-behaviour-with-copy-on-write-cow "Permanent link")
...
Obtaining pandas 3.0 [#](#obtaining-pandas-30 "Permanent link")
---------------------------------------------------------------
...
Running into an issue or regression? [#](#running-into-an-issue-or-regression "Permanent link")
-----------------------------------------------------------------------------------------------
