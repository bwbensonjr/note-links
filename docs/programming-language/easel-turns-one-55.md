...
domain: blog.phronemophobic.com
source_date: '2026-01-01'
tags:
- clojure
- github-repo
- web-dev
summary: Easel is a Clojure-based IDE that celebrates its one-year anniversary, designed
  as a modular "IDE as a library" where independent tools can share data and work
  together. The creator chose the JVM and Clojure as the foundation to solve hard
  problems like garbage collection and REPL-driven development, while addressing the
  softer challenge of building a modern UI library from scratch. The project is approximately
  80% complete with major features already demonstrated, and reflects a philosophy
  of restoring computers as creative, collaborative tools—similar to historical systems
  like NeXTSTEP and Emacs—rather than isolated applications.
...
* [What is Easel?](#What-is-Easel)
* [Why Easel?](#Why-Easel)

+ [The Hard Problems](#The-Hard-Problems)
+ [Social Reasons for Easel](#Social-Reasons-for-Easel)

* [Why Easel Can Succeed](#Why-Easel-Can-Succeed)
* [Status](#Status)
* ["Roadmap"](#Roadmap)
