...
title: sometimes.digital / experiments with plotter art
domain: sometimes.digital
source_date: '2026-08-28'
tags:
- python
- tutorial
- ai
summary: The author has been experimenting with generative art using a repurposed
  3D printer modified into a plotter by attaching a pen with magnets to the print
  head. They use Inkscape with Python scripting extensions to generate and manipulate
  vector-based designs, which are then converted to gcode for the printer to execute,
  finding this workflow particularly frictionless for creative exploration and learning
  new generative techniques. The combination of manual input (hand-drawn shapes) with
  algorithmic manipulation creates an intuitive and engaging process for producing
  plotter art.
fetch_status: success
summarizer_model: global.anthropic.claude-haiku-4-5-20251001-v1:0
---

# sometimes.digital / experiments with plotter art
...
![Scanned plotter drawing of an abstract flowy shape.](2.webp)
...
![Scanned plotter drawing of an abstract flowy shape.](3.webp)
