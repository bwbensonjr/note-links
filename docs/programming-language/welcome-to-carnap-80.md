...
- academic-paper
- tutorial
summary: Carnap.io is a free, open-source logic framework built in Haskell designed
  for teaching and studying formal logic. It is widely used in logic courses at colleges
  and universities worldwide, offering students access to course materials and instructors
  the ability to implement logic instruction. The platform welcomes both students
  and educators, with options for course access and opportunities for those interested
  in contributing to or adopting the project.
