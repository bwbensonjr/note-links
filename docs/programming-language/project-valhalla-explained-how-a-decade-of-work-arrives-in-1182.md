...
title: 'Project Valhalla, Explained: How a Decade of Work Arrives in JDK 28 - JVM
  Weekly vol. 180'
domain: www.jvm-weekly.com
source_date: '2026-06-19'
tags:
- java
- compilers
- tutorial
summary: Project Valhalla, a decade-long initiative to create value classes in Java,
  is finally being integrated into JDK 28 as a preview feature, marking a major milestone
  despite being only the first phase of the project. The initiative aims to solve
  a fundamental Java performance problem by allowing developers to write normal, readable
  classes that the JVM treats as efficiently as primitives, eliminating costly heap
  allocations and improving cache locality for large-scale data structures. The project
  evolved through multiple prototypes over the years, ultimately shifting from a "Q
  World" approach that treated value types as fundamentally separate from objects
  to an "L World" design that integrated them more seamlessly into the existing type
  system.
...
[![Artur Skowronski's avatar](https://substackcdn.com/image/fetch/$s_!RInA!,w_36,h_36,c_fill,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F02ec8807-299f-42d2-bcde-168795228629_2362x2362.png)](https://substack.com/@arturskowronski)

[Artur Skowronski](https://substack.com/@arturskowronski)
